...
public class ToolRegistryTests
{
    ...
    public void List_WithMcpAndInternalTools_ReturnsMixedSortedOrder()
    {
        ...
        registry.Register(
            ...
            new TestTool());
        registry.Register(
            new ToolDescriptor { Id = "gmsd:aos:tool:filesystem:read", Name = "ReadFile", Description = "Read file" },
            new TestTool());
        registry.Register(
            new ToolDescriptor { Id = "mcp:server1:toolB", Name = "McpB", Description = "MCP B" },
            new TestTool());
        registry.Register(
            new ToolDescriptor { Id = "gmsd:aos:tool:git:status", Name = "GitStatus", Description = "Git status" },
            new TestTool());
        ...
        Assert.Equal(new[]
        {
            "gmsd:aos:tool:filesystem:read",
            "gmsd:aos:tool:git:status",
            "mcp:server1:toolA",
            "mcp:server1:toolB"
        }, result);
    }
