...
public sealed class AosValidateWorkspaceSchemaViolationTests
{
    ...
    {
        var tempWorkspaceRoot = CreateTempDirectory("gmsd-aos-validate-workspace-schema-violation");
        try
        {
            ...
            Assert.Contains(
                "FAIL [spec] .aos/spec/project.json - (gmsd:aos:schema:project:v1 @ /schemaVersion)",
                stdout,
