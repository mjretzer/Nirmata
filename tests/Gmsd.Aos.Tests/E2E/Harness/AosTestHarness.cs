...
public sealed class AosTestHarness
{
    ...
    private async Task<RunResult> RunCliAsync(string command, string[] args)
    {
        ...
        {
            throw new InvalidOperationException("Could not find aos.dll. Ensure the Gmsd.Aos project is built.");
        }
    ...
    private static string? FindAosDllPath()
    {
        ...
        var searchPaths = new[]
        {
            ...
            // From tests/Gmsd.Aos.Tests/bin/Debug/net10.0/ go up 5 levels to solution root
            Path.Combine(baseDir, "..", "..", "..", "..", "..", "Gmsd.Aos", "bin", "Debug", "net10.0", "aos.dll"),
            Path.Combine(baseDir, "..", "..", "..", "..", "..", "Gmsd.Aos", "bin", "Release", "net10.0", "aos.dll"),
            Path.Combine(baseDir, "..", "..", "..", "Gmsd.Aos", "aos.dll"),
        };
