...
public class UatArtifactSchemaTests
{
    ...
    public void UatResult_Serializes_WithCorrectSchemaVersion()
    {
        ...
        json.Should().Contain("nirmata:aos:schema:uat-result:v1");
    }
    ...
    public void UatResult_Deserializes_Correctly()
    {
        ...
        result!.SchemaVersion.Should().Be("nirmata:aos:schema:uat-result:v1");
    ...
    public void UatSpec_Serializes_WithCorrectSchemaVersion()
    {
        ...
        {
            SchemaVersion = "nirmata:aos:schema:uat-spec:v1",
            TaskId = "TASK-001",
            Timestamp = DateTimeOffset.Parse("2026-02-06T12:00:00Z"),
            Criteria = new[]
            {
        ...
        json.Should().Contain("nirmata:aos:schema:uat-spec:v1");
    }

    [Fact]
    public void Issue_Serializes_WithCorrectSchemaVersion()
    {
        var issue = new nirmata.Agents.Execution.Verification.Issues.Issue
        {
        ...
        json.Should().Contain("nirmata:aos:schema:issue:v1");
    }
