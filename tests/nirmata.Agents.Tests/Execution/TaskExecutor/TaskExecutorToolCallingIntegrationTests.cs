...
namespace nirmata.Agents.Tests.Execution.TaskExecutor;
...
public class TaskExecutorToolCallingIntegrationTests
{
    ...
    private readonly nirmata.Agents.Execution.Execution.TaskExecutor.TaskExecutor _sut;
    ...
    public TaskExecutorToolCallingIntegrationTests()
    {
        ...
        _sut = new nirmata.Agents.Execution.Execution.TaskExecutor.TaskExecutor(
