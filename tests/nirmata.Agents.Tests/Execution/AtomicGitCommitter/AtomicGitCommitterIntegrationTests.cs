...
using AtomicGitCommitterAlias = nirmata.Agents.Execution.Execution.AtomicGitCommitter.AtomicGitCommitter;
...
namespace nirmata.Agents.Tests.Execution.AtomicGitCommitter;
