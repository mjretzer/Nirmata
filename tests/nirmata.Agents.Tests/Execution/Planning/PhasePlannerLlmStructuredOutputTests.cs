...
public class PhasePlannerLlmStructuredOutputTests
{
    ...
    private readonly nirmata.Agents.Execution.Planning.PhasePlanner.PhasePlanner _sut;
    ...
    public PhasePlannerLlmStructuredOutputTests()
    {
        ...
        _sut = new nirmata.Agents.Execution.Planning.PhasePlanner.PhasePlanner(_llmProviderMock.Object, _workspaceMock.Object);
    }
