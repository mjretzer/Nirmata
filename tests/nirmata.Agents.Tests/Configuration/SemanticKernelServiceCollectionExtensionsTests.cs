...
namespace nirmata.Agents.Tests.Configuration;
...
public class SemanticKernelServiceCollectionExtensionsTests
{
    ...
    public void AddSemanticKernel_WithOpenAiProvider_BindsConfigurationCorrectly(string providerName)
    {
        ...
        var configuration = new ConfigurationBuilder()
            ...
            {
                ["nirmataAgents:SemanticKernel:Provider"] = providerName,
                ["nirmataAgents:SemanticKernel:OpenAi:ApiKey"] = "test-api-key",
                ["nirmataAgents:SemanticKernel:OpenAi:ModelId"] = "gpt-4o",
                ["nirmataAgents:SemanticKernel:OpenAi:Temperature"] = "0.7",
                ["nirmataAgents:SemanticKernel:OpenAi:MaxTokens"] = "4096",
                ["nirmataAgents:SemanticKernel:OpenAi:TopP"] = "0.9",
                ["nirmataAgents:SemanticKernel:OpenAi:FrequencyPenalty"] = "0.5",
                ["nirmataAgents:SemanticKernel:OpenAi:PresencePenalty"] = "0.3",
                ["nirmataAgents:SemanticKernel:OpenAi:Seed"] = "42",
                ["nirmataAgents:SemanticKernel:OpenAi:EnableParallelToolCalls"] = "true",
                ["nirmataAgents:SemanticKernel:OpenAi:OrganizationId"] = "test-org",
                ["nirmataAgents:SemanticKernel:OpenAi:BaseUrl"] = "https://custom.openai.com"
            })
            .Build();
    ...
    public void AddSemanticKernel_WithAzureOpenAiProvider_BindsConfigurationCorrectly(string providerName)
    {
        ...
        var configuration = new ConfigurationBuilder()
            ...
            {
                ["nirmataAgents:SemanticKernel:Provider"] = providerName,
                ["nirmataAgents:SemanticKernel:AzureOpenAi:Endpoint"] = "https://test.openai.azure.com",
                ["nirmataAgents:SemanticKernel:AzureOpenAi:ApiKey"] = "test-azure-key",
                ["nirmataAgents:SemanticKernel:AzureOpenAi:DeploymentName"] = "gpt-4-deployment",
                ["nirmataAgents:SemanticKernel:AzureOpenAi:ApiVersion"] = "2024-06-01"
            })
            .Build();
    ...
    public void AddSemanticKernel_WithOllamaProvider_BindsConfigurationCorrectly(string providerName)
    {
        ...
        var configuration = new ConfigurationBuilder()
            ...
            {
                ["nirmataAgents:SemanticKernel:Provider"] = providerName,
                ["nirmataAgents:SemanticKernel:Ollama:BaseUrl"] = "http://localhost:11434",
                ["nirmataAgents:SemanticKernel:Ollama:ModelId"] = "llama3"
            })
            .Build();
    ...
    public void AddSemanticKernel_WithAnthropicProvider_BindsConfigurationCorrectly(string providerName)
    {
        ...
        var configuration = new ConfigurationBuilder()
            ...
            {
                ["nirmataAgents:SemanticKernel:Provider"] = providerName,
                ["nirmataAgents:SemanticKernel:Anthropic:ApiKey"] = "test-anthropic-key",
                ["nirmataAgents:SemanticKernel:Anthropic:ModelId"] = "claude-3-opus-20240229",
                ["nirmataAgents:SemanticKernel:Anthropic:BaseUrl"] = "https://api.anthropic.com",
                ["nirmataAgents:SemanticKernel:Anthropic:ApiVersion"] = "2023-06-01"
            })
            .Build();
    ...
    public void AddSemanticKernel_WithOpenAiProvider_UsesDefaultValues()
    {
        ...
        var configuration = new ConfigurationBuilder()
            .AddInMemoryCollection(new Dictionary<string, string?>
            {
                ["nirmataAgents:SemanticKernel:Provider"] = "OpenAi",
                ["nirmataAgents:SemanticKernel:OpenAi:ApiKey"] = "test-key",
                ["nirmataAgents:SemanticKernel:OpenAi:ModelId"] = "gpt-4o"
            })
            .Build();
    ...
    public void AddSemanticKernel_WithOllamaProvider_UsesDefaultValues()
    {
        ...
        var configuration = new ConfigurationBuilder()
            .AddInMemoryCollection(new Dictionary<string, string?>
            {
                ["nirmataAgents:SemanticKernel:Provider"] = "Ollama",
                ["nirmataAgents:SemanticKernel:Ollama:ModelId"] = "mistral"
            })
            .Build();
    ...
    public void AddSemanticKernel_WithAnthropicProvider_UsesDefaultValues()
    {
        ...
        var configuration = new ConfigurationBuilder()
            .AddInMemoryCollection(new Dictionary<string, string?>
            {
                ["nirmataAgents:SemanticKernel:Provider"] = "Anthropic",
                ["nirmataAgents:SemanticKernel:Anthropic:ApiKey"] = "test-key",
                ["nirmataAgents:SemanticKernel:Anthropic:ModelId"] = "claude-3-sonnet-20240229"
            })
            .Build();
    ...
    public void AddSemanticKernel_WithMissingSemanticKernelSection_ThrowsInvalidOperationException()
    {
        ...
        exception.Message.Should().Contain("nirmataAgents:SemanticKernel");
    }
    ...
    public void AddSemanticKernel_WithUnknownProvider_ThrowsInvalidOperationException()
    {
        ...
        var configuration = new ConfigurationBuilder()
            .AddInMemoryCollection(new Dictionary<string, string?>
            {
                ["nirmataAgents:SemanticKernel:Provider"] = "UnknownProvider",
                ["nirmataAgents:SemanticKernel:OpenAi:ApiKey"] = "test-key",
                ["nirmataAgents:SemanticKernel:OpenAi:ModelId"] = "gpt-4o"
            })
            .Build();
    ...
    public void AddSemanticKernel_WithOpenAiProviderInvalidModel_ThrowsInvalidOperationException()
    {
        ...
        var configuration = new ConfigurationBuilder()
            .AddInMemoryCollection(new Dictionary<string, string?>
            {
                ["nirmataAgents:SemanticKernel:Provider"] = "OpenAi",
                ["nirmataAgents:SemanticKernel:OpenAi:ApiKey"] = "test-key",
                ["nirmataAgents:SemanticKernel:OpenAi:ModelId"] = "invalid-model-xyz"
            })
            .Build();
    ...
    public void AddSemanticKernel_WithAzureOpenAiProviderMissingConfiguration_ThrowsInvalidOperationException()
    {
        ...
        var configuration = new ConfigurationBuilder()
            .AddInMemoryCollection(new Dictionary<string, string?>
            {
                ["nirmataAgents:SemanticKernel:Provider"] = "AzureOpenAi"
            })
            .Build();
    ...
    public void AddSemanticKernel_WithAzureOpenAiProviderMissingEndpoint_ThrowsInvalidOperationException()
    {
        ...
        var configuration = new ConfigurationBuilder()
            ...
            {
                ["nirmataAgents:SemanticKernel:Provider"] = "AzureOpenAi",
                ["nirmataAgents:SemanticKernel:AzureOpenAi:ApiKey"] = "test-key",
                ["nirmataAgents:SemanticKernel:AzureOpenAi:DeploymentName"] = "gpt-4"
            })
            .Build();
    ...
    public void ScanAndRegisterTools_RegistersToolsFromAssembly()
    {
        ...
        tools.Should().Contain(t => t.GetType() == typeof(nirmata.Agents.Tests.Fakes.ScannableFakeTool));
    }
