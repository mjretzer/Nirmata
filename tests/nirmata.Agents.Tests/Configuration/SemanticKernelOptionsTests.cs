...
public class SemanticKernelOptionsTests
{
    ...
    public void ValidOpenAiConfiguration_LoadsSuccessfully()
    {
        ...
        var configuration = new ConfigurationBuilder()
            .AddInMemoryCollection(new Dictionary<string, string?>
            {
                ...
                ["nirmataAgents:SemanticKernel:OpenAi:ApiKey"] = "sk-test-key",
                ["nirmataAgents:SemanticKernel:OpenAi:ModelId"] = "gpt-4"
            })
            .Build();
    ...
    public void ValidAzureOpenAiConfiguration_LoadsSuccessfully()
    {
        ...
        var configuration = new ConfigurationBuilder()
            .AddInMemoryCollection(new Dictionary<string, string?>
            {
                ...
                ["nirmataAgents:SemanticKernel:AzureOpenAi:ApiKey"] = "azure-key",
    ...
    public void ValidAnthropicConfiguration_LoadsSuccessfully()
    {
        ...
        var configuration = new ConfigurationBuilder()
            .AddInMemoryCollection(new Dictionary<string, string?>
            {
                ...
                ["nirmataAgents:SemanticKernel:Anthropic:ApiKey"] = "sk-ant-test",
    ...
    public void EmptyProvider_ReturnsOptionsWithEmptyProvider()
    {
        ...
        var configuration = new ConfigurationBuilder()
            .AddInMemoryCollection(new Dictionary<string, string?>
            {
                ["nirmataAgents:SemanticKernel:Provider"] = ""
            })
            .Build();
    ...
    public void MissingOpenAiModelId_ReturnsOptionsWithoutModelId()
    {
        ...
        var configuration = new ConfigurationBuilder()
            ...
            {
                ["nirmataAgents:SemanticKernel:Provider"] = "OpenAi",
                ["nirmataAgents:SemanticKernel:OpenAi:ApiKey"] = "sk-test"
            })
            .Build();
    ...
    public void OpenAiConfiguration_WithAllOptionalFields_LoadsSuccessfully()
    {
        ...
        var configuration = new ConfigurationBuilder()
            .AddInMemoryCollection(new Dictionary<string, string?>
            {
                ...
                ["nirmataAgents:SemanticKernel:OpenAi:ApiKey"] = "sk-test",
                ["nirmataAgents:SemanticKernel:OpenAi:ModelId"] = "gpt-4",
                ["nirmataAgents:SemanticKernel:OpenAi:OrganizationId"] = "org-123",
                ...
                ["nirmataAgents:SemanticKernel:OpenAi:EnableParallelToolCalls"] = "false"
            })
            .Build();
    ...
    public void OpenAiConfiguration_WithValidTemperature_LoadsSuccessfully(double temperature)
    {
        ...
        var configuration = new ConfigurationBuilder()
            .AddInMemoryCollection(new Dictionary<string, string?>
            {
                ...
                ["nirmataAgents:SemanticKernel:OpenAi:ApiKey"] = "sk-test",
                ["nirmataAgents:SemanticKernel:OpenAi:ModelId"] = "gpt-4",
                ["nirmataAgents:SemanticKernel:OpenAi:Temperature"] = temperature.ToString()
            })
            .Build();
    ...
    public void OpenAiConfiguration_WithValidTopP_LoadsSuccessfully(double topP)
    {
        ...
        var configuration = new ConfigurationBuilder()
            .AddInMemoryCollection(new Dictionary<string, string?>
            {
                ...
                ["nirmataAgents:SemanticKernel:OpenAi:ApiKey"] = "sk-test",
                ["nirmataAgents:SemanticKernel:OpenAi:ModelId"] = "gpt-4",
                ["nirmataAgents:SemanticKernel:OpenAi:TopP"] = topP.ToString()
            })
            .Build();
    ...
    public void OllamaConfiguration_WithCustomBaseUrl_LoadsSuccessfully()
    {
        ...
        var configuration = new ConfigurationBuilder()
            ...
            {
                ["nirmataAgents:SemanticKernel:Provider"] = "Ollama",
                ["nirmataAgents:SemanticKernel:Ollama:BaseUrl"] = "http://192.168.1.100:11434",
    ...
    public void AnthropicConfiguration_WithCustomBaseUrl_LoadsSuccessfully()
    {
        ...
        var configuration = new ConfigurationBuilder()
            .AddInMemoryCollection(new Dictionary<string, string?>
            {
                ...
                ["nirmataAgents:SemanticKernel:Anthropic:BaseUrl"] = "https://custom.anthropic.com"
            })
            .Build();
    ...
    {
        // Assert
        SemanticKernelOptions.SectionName.Should().Be("nirmataAgents:SemanticKernel");
    }
