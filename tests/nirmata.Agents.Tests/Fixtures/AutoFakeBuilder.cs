...
public sealed class AutoFakeBuilder
{
    ...
    public AutoFakeBuilder()
    {
        ...
        _atomicGitCommitterHandlerMock = new Mock<AtomicGitCommitterHandler>(
            Mock.Of<global::nirmata.Agents.Execution.Execution.AtomicGitCommitter.IAtomicGitCommitter>(),
            Mock.Of<IWorkspace>(),
            Mock.Of<IStateStore>());
        ...
        _codebaseMapperHandlerMock = new Mock<CodebaseMapperHandler>(
            Mock.Of<global::nirmata.Agents.Execution.Brownfield.CodebaseScanner.ICodebaseScanner>(),
            Mock.Of<global::nirmata.Agents.Execution.Brownfield.MapValidator.IMapValidator>(),
            Mock.Of<global::nirmata.Agents.Execution.Brownfield.SymbolCacheBuilder.ISymbolCacheBuilder>(),
            Mock.Of<IWorkspace>(),
        ...
        _fixPlannerHandlerMock = new Mock<FixPlannerHandler>(
            Mock.Of<global::nirmata.Agents.Execution.FixPlanner.IFixPlanner>(),
            Mock.Of<IWorkspace>(),
            Mock.Of<IStateStore>(),
            Mock.Of<IRunLifecycleManager>(),
        ...
        _taskExecutorHandlerMock = new Mock<TaskExecutorHandler>(
            Mock.Of<global::nirmata.Agents.Execution.Execution.TaskExecutor.ITaskExecutor>(),
            Mock.Of<IWorkspace>(),
            Mock.Of<IStateStore>(),
            Mock.Of<ISpecStore>(),
            Mock.Of<IRunLifecycleManager>());
        ...
        _verifierHandlerMock = new Mock<VerifierHandler>(
            Mock.Of<global::nirmata.Agents.Execution.Verification.UatVerifier.IUatVerifier>(),
            Mock.Of<global::nirmata.Agents.Execution.Verification.Issues.IIssueWriter>(),
            Mock.Of<IWorkspace>(),
            Mock.Of<IStateStore>(),
            Mock.Of<IRunLifecycleManager>());
