...
public class DaemonCorsTests : IClassFixture<DaemonApiFactory>
{
    ...
    public async Task OptionsPreflight_FromHttpsFrontendOrigin_Returns204AndAllowsOrigin(string path, string method)
    {
        var request = new HttpRequestMessage(HttpMethod.Options, path);
        request.Headers.Add("Origin", "https://localhost:8443");
        ...
        Assert.Contains("https://localhost:8443", allowOrigins);
