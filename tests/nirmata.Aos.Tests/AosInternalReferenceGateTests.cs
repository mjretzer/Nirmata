...
public sealed class AosInternalReferenceGateTests
{
    ...
    public async Task ConsumerProject_CannotCompileAgainstEngineInternals()
    {
        ...
        try
        {
            ...
            var aosProjectPath = Path.Combine(repoRoot, "nirmata.Aos", "nirmata.Aos.csproj");
            ...
            File.WriteAllText(
                ...
                <Project Sdk="Microsoft.NET.Sdk">
                  <PropertyGroup>
                    ...
                    <nirmataBoundaryEnforcementEnabled>false</nirmataBoundaryEnforcementEnabled>
                  </PropertyGroup>
                  <ItemGroup>
    ...
    {
        var root = Path.Combine(Path.GetTempPath(), "nirmata-aos-internal-ref-gate", Guid.NewGuid().ToString("N"));
