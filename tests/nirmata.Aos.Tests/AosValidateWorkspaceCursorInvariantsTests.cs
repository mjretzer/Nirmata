...
public sealed class AosValidateWorkspaceCursorInvariantsTests
{
    ...
    {
        var tempWorkspaceRoot = CreateTempDirectory("nirmata-aos-validate-workspace-cursor-kind-without-id");
        try
        {
    ...
    {
        var tempWorkspaceRoot = CreateTempDirectory("nirmata-aos-validate-workspace-cursor-unrecognized-kind");
        try
        {
            var aosDllPath = typeof(AosWorkspaceBootstrapper).Assembly.Location;
            Assert.True(File.Exists(aosDllPath), $"aos assembly not found at '{aosDllPath}'.");
    ...
    {
        var tempWorkspaceRoot = CreateTempDirectory("nirmata-aos-validate-workspace-cursor-kind-id-mismatch");
        try
        {
            var aosDllPath = typeof(AosWorkspaceBootstrapper).Assembly.Location;
            Assert.True(File.Exists(aosDllPath), $"aos assembly not found at '{aosDllPath}'.");
    ...
    {
        var tempWorkspaceRoot = CreateTempDirectory("nirmata-aos-validate-workspace-cursor-missing-artifact");
        try
        {
            var aosDllPath = typeof(AosWorkspaceBootstrapper).Assembly.Location;
            Assert.True(File.Exists(aosDllPath), $"aos assembly not found at '{aosDllPath}'.");
    ...
    {
        var tempWorkspaceRoot = CreateTempDirectory("nirmata-aos-validate-workspace-cursor-missing-from-catalog-index");
        try
        {
            var aosDllPath = typeof(AosWorkspaceBootstrapper).Assembly.Location;
            Assert.True(File.Exists(aosDllPath), $"aos assembly not found at '{aosDllPath}'.");
