...
namespace nirmata.Aos.Tests.Composition;
...
public class ServiceCollectionExtensionsTests
{
    private static IServiceCollection CreateTestServices(string repositoryRootPath)
    {
        ...
        var configuration = new ConfigurationBuilder()
            ...
            {
                ["nirmataAos:RepositoryRootPath"] = repositoryRootPath
            })
            .Build();
    ...
    [Fact]
    public void AddnirmataAos_RegistersAosOptions()
    {
    ...
    [Fact]
    public void AddnirmataAos_RegistersIWorkspace_AsSingleton()
    {
        var repositoryRoot = CreateTempRepositoryRoot();
        var services = CreateTestServices(repositoryRoot);
    ...
    [Fact]
    public void AddnirmataAos_RegistersISpecStore_AsSingleton()
    {
        var repositoryRoot = CreateTempRepositoryRoot();
        var services = CreateTestServices(repositoryRoot);
    ...
    [Fact]
    public void AddnirmataAos_RegistersIStateStore_AsSingleton()
    {
        var repositoryRoot = CreateTempRepositoryRoot();
        var services = CreateTestServices(repositoryRoot);
    ...
    [Fact]
    public void AddnirmataAos_RegistersIEvidenceStore_AsSingleton()
    {
        var repositoryRoot = CreateTempRepositoryRoot();
        var services = CreateTestServices(repositoryRoot);
    ...
    [Fact]
    public void AddnirmataAos_RegistersIValidator_AsSingleton()
    {
        var repositoryRoot = CreateTempRepositoryRoot();
        var services = CreateTestServices(repositoryRoot);
    ...
    [Fact]
    public void AddnirmataAos_RegistersCommandCatalog_AsSingleton()
    {
        var repositoryRoot = CreateTempRepositoryRoot();
        var services = CreateTestServices(repositoryRoot);
    ...
    [Fact]
    public void AddnirmataAos_RegistersICommandRouter_AsScoped()
    {
        var repositoryRoot = CreateTempRepositoryRoot();
        var services = CreateTestServices(repositoryRoot);
    ...
    [Fact]
    public void AddnirmataAos_WithPathOverload_RegistersAllServices()
    {
        var repositoryRoot = CreateTempRepositoryRoot();
        var services = new ServiceCollection();

        services.AddnirmataAos(repositoryRoot);
    ...
    [Fact]
    public void AddnirmataAos_StoresShareWorkspacePath()
    {
        var repositoryRoot = CreateTempRepositoryRoot();
        var services = CreateTestServices(repositoryRoot);
