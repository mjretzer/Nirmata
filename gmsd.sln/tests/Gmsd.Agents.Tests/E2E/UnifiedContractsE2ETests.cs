...
public class UnifiedContractsE2ETests
{
    ...
    public void E2E_DiagnosticDiscovery_ListsAllDiagnostics()
    {
        ...
        var diagnostics = Gmsd.Agents.Execution.Validation.DiagnosticArtifactReader.ListAll(aosRoot).ToList();
    ...
    public void E2E_DiagnosticDiscovery_ByPhase()
    {
        ...
        var taskDiagnostics = Gmsd.Agents.Execution.Validation.DiagnosticArtifactReader.ListByPhase(aosRoot, "task-execution").ToList();
        var phaseDiagnostics = Gmsd.Agents.Execution.Validation.DiagnosticArtifactReader.ListByPhase(aosRoot, "phase-planning").ToList();
