...
public class SchemaContractComplianceTests
{
    ...
    public SchemaContractComplianceTests()
    {
        ...
        _phasePlanSchema = LoadSchema(assembly, "Gmsd.Aos.Resources.Schemas.phase-plan.schema.json");
        _fixPlanSchema = LoadSchema(assembly, "Gmsd.Aos.Resources.Schemas.fix-plan.schema.json");
        _commandProposalSchema = LoadSchema(assembly, "Gmsd.Aos.Resources.Schemas.command-proposal.schema.json");
    }
