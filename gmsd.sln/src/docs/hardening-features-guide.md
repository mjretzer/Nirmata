# GMSD Orchestrator Hardening Features Guide

This guide covers the production-grade safety features added to the GMSD orchestrator: workspace locking, run abandonment detection, pause/resume functionality, rate limiting, and secret management.

## Overview

The GMSD orchestrator now includes five major hardening features designed to make it suitable for production use:
...
**Solution:**
1. Check cleanup task is running: `Get-Service GmsdService`
...
export GMSD_SECRET_OPENAI_API_KEY="sk-..."
export GMSD_SECRET_AZURE_OPENAI_KEY="..."
