...
using Gmsd.Agents.Execution.LlmProvider;
...
using Gmsd.Aos.Public.Composition;
...
public static class ServiceCollectionExtensions
{
        ...
        IConfiguration configuration)
    {
        ...
        services.Configure<CommandSuggestionOptions>(configuration.GetSection("GmsdAgents:CommandSuggestion"));
