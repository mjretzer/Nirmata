...
public sealed class ProjectSpecGenerator : IProjectSpecGenerator
{
    ...
    public SpecValidationResult Validate(ProjectSpecification spec)
    {
        ...
        else if (!spec.Schema.Equals("gmsd:aos:schema:project:v1", StringComparison.OrdinalIgnoreCase))
        {
            errors.Add($"Unexpected schema: {spec.Schema}. Expected: gmsd:aos:schema:project:v1");
        }
