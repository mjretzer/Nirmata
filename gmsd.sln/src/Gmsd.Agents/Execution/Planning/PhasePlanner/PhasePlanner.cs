...
public sealed class PhasePlanner : IPhasePlanner
{
    ...
    private static readonly Lazy<string> PhasePlanSchemaJson = new(() =>
        LoadEmbeddedSchema("Gmsd.Aos.Resources.Schemas.phase-plan.schema.json"),
...
You MUST respond with JSON that conforms to the provided phase plan schema (gmsd:aos:schema:phase-plan:v1).";
    }
