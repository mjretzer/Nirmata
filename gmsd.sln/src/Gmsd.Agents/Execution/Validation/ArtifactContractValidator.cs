...
{
    private const string PhasePlanSchemaId = "gmsd:aos:schema:phase-plan:v1";
    private const string TaskPlanSchemaId = "gmsd:aos:schema:task-plan:v1";
    private const string VerifierInputSchemaId = "gmsd:aos:schema:verifier-input:v1";
    private const string VerifierOutputSchemaId = "gmsd:aos:schema:verifier-output:v1";
    private const string FixPlanSchemaId = "gmsd:aos:schema:fix-plan:v1";
    private const string DiagnosticSchemaId = "gmsd:aos:schema:diagnostic:v1";
