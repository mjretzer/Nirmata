...
// Add Razor Pages services with layout filter
builder.Services.AddRazorPages(options =>
{
    options.Conventions.Add(new LayoutSelectorPageConvention());
});

// Add HttpContextAccessor for feature flag evaluation
