...
- **Affected code**: 
  - `Gmsd.Agents/Execution/Preflight/InputClassifier.cs` (add suggestion mode hook)
  - `Gmsd.Agents/Execution/Preflight/CommandSuggestion/...` (new)
  - `Gmsd.Agents/Execution/Preflight/ConfirmationGate.cs` (handle suggested commands)
