...
- Command Interface: `Gmsd.Agents/Execution/ControlPlane/Commands/ICommand.cs`
- Chat Responder: `Gmsd.Agents/Execution/ControlPlane/Chat/IChatResponder.cs`
- Streaming Events: `Gmsd.Web/Models/Streaming/StreamingEventType.cs`
- Event Renderers: `Gmsd.Web/wwwroot/js/ievent-renderer.js`
