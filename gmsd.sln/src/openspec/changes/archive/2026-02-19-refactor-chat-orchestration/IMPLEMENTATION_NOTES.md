...
- `tests/Gmsd.Agents.Tests/Execution/Commands/CommandParserTests.cs`
...
**Files:**
- `Gmsd.Agents/Execution/Preflight/InputClassifier.cs`
- `Gmsd.Agents/Execution/ControlPlane/Orchestrator.cs`
...
- `Gmsd.Web/wwwroot/js/command-proposal-renderers.js` (NEW)
- `Gmsd.Web/wwwroot/css/command-proposal-cards.css` (NEW)
- `Gmsd.Web/wwwroot/js/command-suggestion-telemetry.js` (NEW)
...
**Files:**
- `Gmsd.Agents/Execution/ControlPlane/Chat/LlmChatResponder.cs`
- `Gmsd.Agents/Execution/ControlPlane/Chat/ChatContextAssembly.cs`
- `Gmsd.Agents/Execution/ControlPlane/Chat/ReadOnlyToolRegistry.cs`
- `Gmsd.Agents/Execution/ControlPlane/Chat/ChatPromptBuilder.cs` (ENHANCED)
- `Gmsd.Agents/Execution/ControlPlane/Chat/ConversationHistoryManager.cs` (NEW)
...
**Files:**
- `Gmsd.Agents/Execution/ControlPlane/Orchestrator.cs`
- `Gmsd.Agents/Execution/ControlPlane/GatingEngine.cs`
...
**Files:**
- `Gmsd.Web/wwwroot/js/command-proposal-renderers.js` (NEW)
- `Gmsd.Web/wwwroot/js/command-autocomplete.js` (NEW)
- `Gmsd.Web/wwwroot/css/command-proposal-cards.css` (NEW)
- `Gmsd.Web/wwwroot/css/command-autocomplete.css` (NEW)
- `Gmsd.Web/Controllers/ChatStreamingController.cs` (ENHANCED)
...
**Files:**
- `tests/Gmsd.Agents.Tests/Execution/ControlPlane/Chat/LlmChatResponderTests.cs`
- `tests/Gmsd.Agents.Tests/Execution/ControlPlane/Chat/CommandSuggestionDetectorTests.cs`
- `tests/Gmsd.Web.Tests/ChatStreamingControllerTests.cs`
