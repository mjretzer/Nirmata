...
2. Create `tests/Gmsd.Aos.Tests/E2E/Harness/` folder
...
1. ✅ Create `tests/Gmsd.Aos.Tests/E2E/InitVerification/` folder
...
1. ✅ Create `tests/Gmsd.Agents.Tests/E2E/ControlLoop/` folder
...
1. Update `Gmsd.slnx` to include new test projects
