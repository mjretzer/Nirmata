...
### Goals
- Provide a public routing surface in `Gmsd.Aos.Public.Services` that callers can compile against
...
| Public surface couples to command contracts | Use stable contract types in `Gmsd.Aos.Contracts.Commands` |
