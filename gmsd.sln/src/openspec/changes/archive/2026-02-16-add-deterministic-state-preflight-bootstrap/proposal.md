...
- Affected code (expected):
  - `Gmsd.Aos` state/workspace initialization surfaces and store behavior
  - `Gmsd.Agents` preflight/prerequisite validation and orchestrator control flow
  - associated tests in `tests/Gmsd.Aos.Tests` and `tests/Gmsd.Agents.Tests`
