...
The `Gmsd.Web` project SHALL provide a `/Command` page with a modern chat-style UI for interacting with the AOS engine.
...
- **THEN** a safety rail banner shows: "Scope: Gmsd.Web/Pages/**", "Files to modify: 3"
