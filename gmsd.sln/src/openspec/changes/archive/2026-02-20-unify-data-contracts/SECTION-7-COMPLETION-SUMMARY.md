...
#### `Gmsd.Agents/Execution/Migration/ArtifactFormatDetector.cs`
...
#### `Gmsd.Agents/Execution/Migration/ArtifactTransformer.cs`
...
#### `Gmsd.Agents/Execution/Migration/SchemaMigrator.cs`
...
#### `Gmsd.Agents/Execution/Migration/MigrationCommand.cs`
...
#### `tests/Gmsd.Agents.Tests/Execution/Migration/SchemaMigratorTests.cs`
Unit tests covering:
...
#### `tests/Gmsd.Agents.Tests/Execution/Migration/SchemaMigratorIntegrationTests.cs`
...
```
Gmsd.Agents/Execution/Migration/
├── ArtifactFormatDetector.cs
├── ArtifactTransformer.cs
├── SchemaMigrator.cs
└── MigrationCommand.cs

tests/Gmsd.Agents.Tests/Execution/Migration/
