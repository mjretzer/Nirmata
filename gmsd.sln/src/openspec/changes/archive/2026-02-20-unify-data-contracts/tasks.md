...
- [x] 6.8 Create CLI command `gmsd validate-artifact --path <path>` for manual validation
- [x] 6.9 Create CLI command `gmsd list-diagnostics --workspace <path>` for diagnostic discovery
...
- [x] 7.3 Implement migration CLI command: `gmsd migrate-schemas --workspace-path <path> [--dry-run] [--backup]`
