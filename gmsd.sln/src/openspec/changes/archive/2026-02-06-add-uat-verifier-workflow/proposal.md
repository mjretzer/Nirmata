...
## What Changes
- **ADDED:** `IUatVerifier` interface and `UatVerifier` implementation in `Gmsd.Agents/Execution/Verification/UatVerifier/`
...
- **Affected code paths:** `Gmsd.Agents/Execution/Verification/UatVerifier/**`, `Gmsd.Agents/Execution/ControlPlane/`
