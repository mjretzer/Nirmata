...
- **ADDED** `PauseResumeManager` class in `Gmsd.Agents/Execution/Continuity/PauseResumeManager/` to orchestrate pause and resume operations
...
- **Affected code:** `Gmsd.Agents/Execution/Continuity/**` (new directory structure)
