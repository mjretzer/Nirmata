...
- [x] 1.1.1 Create `Gmsd.Services/Composition/` directory
- [x] 1.1.2 Create `ServiceCollectionExtensions.cs` with `AddGmsdServices()` method
...
- [x] 1.4.1 Add `using Gmsd.Services.Composition;` to `Gmsd.Api/Program.cs`
- [x] 1.4.2 Replace inline `AddScoped<IProjectService, ProjectService>()` with `AddGmsdServices()`

## 2. Testing

### 2.1 Create Services Test Project
- [x] 2.1.1 Create `tests/Gmsd.Services.Tests/` project
- [x] 2.1.2 Add project references: `Gmsd.Services`, `Gmsd.Data`, `Gmsd.Data.Dto`
...
- [x] 3.1 Build succeeds: `dotnet build Gmsd.slnx` (verified individual projects)
- [x] 3.2 All existing tests pass: `dotnet test` (4 API tests pass)
- [x] 3.3 New service tests pass: `dotnet test tests/Gmsd.Services.Tests/` (6 tests pass)
