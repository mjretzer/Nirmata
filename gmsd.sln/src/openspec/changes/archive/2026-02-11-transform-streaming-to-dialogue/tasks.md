...
- [x] Define `StreamingEvent` base envelope class in `Gmsd.Web/Models/Streaming`
...
**Implementation**:
- C# performance tests: `tests/Gmsd.Web.Tests/Models/Streaming/StreamingPerformanceTests.cs`
...
- JS performance tests: `tests/Gmsd.Web/js/streaming-performance.test.js`
