...
- [x] 2.5 Implement evidence logging for actions taken under `.aos/evidence/runs/<run-id>/logs/**` (place evidence-writing code under `Gmsd.Aos/Engine/Evidence/ExecutePlan/**`).
