...
- [x] Validate generated roadmap against schema `gmsd:aos:schema:roadmap:v1`
...
- [x] Ensure state validates against `gmsd:aos:schema:state:v1`
...
- [x] Ensure event validates against `gmsd:aos:schema:event:v1`
...
- [x] Unit tests: `RoadmapGeneratorTests` in `tests/Gmsd.Agents.Tests/Workflows/Planning/RoadmapGeneratorTests.cs`
- [x] Unit tests: `RoadmapperTests` in `tests/Gmsd.Agents.Tests/Workflows/Planning/RoadmapperTests.cs`
- [x] Integration tests: Full workflow with temp workspace in `tests/Gmsd.Agents.Tests/Workflows/Planning/RoadmapperIntegrationTests.cs`
...
- [x] README.md in `Gmsd.Agents/Workflows/Planning/Roadmapper/`
