...
- [x] **T1.1** Define `IChatResponder` interface with blocking and streaming methods
  - Location: `Gmsd.Agents/Execution/ControlPlane/Chat/IChatResponder.cs`
...
- [x] **T1.2** Define chat request/response model contracts
  - Location: `Gmsd.Agents/Execution/ControlPlane/Chat/Models/`
...
- [x] **T1.3** Define `IChatContextAssembly` interface
  - Location: `Gmsd.Agents/Execution/ControlPlane/Chat/IChatContextAssembly.cs`
...
- [x] **T2.1** Implement `ChatContextAssembly` service
  - Location: `Gmsd.Agents/Execution/ControlPlane/Chat/ChatContextAssembly.cs`
...
- [x] **T2.2** Implement context summarization (prevent token bloat)
  - Location: `Gmsd.Agents/Execution/ControlPlane/Chat/ContextSummarizer.cs`
...
- [x] **T2.3** Implement `ChatPromptBuilder`
  - Location: `Gmsd.Agents/Execution/ControlPlane/Chat/ChatPromptBuilder.cs`
...
- [x] **T3.1** Implement `LlmChatResponder`
  - Location: `Gmsd.Agents/Execution/ControlPlane/Chat/LlmChatResponder.cs`
...
- [x] **T3.3** Wire up dependency injection
  - Location: `Gmsd.Agents/Configuration/GmsdAgentsServiceCollectionExtensions.cs`
...
- [x] **T4.1** Refactor `ChatResponder` to use `IChatResponder`
  - Location: `Gmsd.Agents/Execution/ControlPlane/ChatResponder.cs`
...
- [x] **T4.2** Refactor `ResponderHandler` to use `IChatResponder`
  - Location: `Gmsd.Agents/Execution/ControlPlane/ResponderHandler.cs`
...
- [x] **T4.3** Update `Orchestrator` to inject and use `IChatResponder`
  - Location: `Gmsd.Agents/Execution/ControlPlane/Orchestrator.cs`
...
- [x] **T5.1** Define SSE event types for chat streaming
  - Location: `Gmsd.Agents/Execution/ControlPlane/Streaming/`
...
- [x] **T5.2** Update streaming controller to use chat streaming
  - Location: `Gmsd.Web/Controllers/ChatStreamingController.cs`
...
- [x] **T6.1** Unit tests for `ChatContextAssembly`
  - Location: `tests/Gmsd.Agents.Tests/Execution/ControlPlane/Chat/`
...
- [x] **T6.3** Integration tests for chat flow
  - Location: `tests/Gmsd.Agents.Tests/E2E/`
