...
- **Affected code (expected)**:
  - CLI routing and exit codes: `Gmsd.Aos/Composition/Program.cs`
  - Evidence writers: `Gmsd.Aos/Engine/Evidence/**`
  - Workspace validation gates: `Gmsd.Aos/Engine/Validation/**`
  - State store and events: `Gmsd.Aos/Engine/Stores/AosStateStore.cs`
