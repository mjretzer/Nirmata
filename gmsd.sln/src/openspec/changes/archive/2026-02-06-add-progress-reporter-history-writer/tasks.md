...
- [x] 1.3 Create `Gmsd.Agents/Execution/Continuity/ProgressReporter/` directory structure
- [x] 1.4 Create `Gmsd.Agents/Execution/Continuity/HistoryWriter/` directory structure
