...
## Scope
- **Gmsd.Web**: `WorkspaceService`, `WorkspaceController`, and `WorkspaceModels`.
- **Gmsd.Aos**: `AosWorkspaceBootstrapper` enhancements for repair and index rebuilding.
- **Gmsd.Data**: Workspace metadata persistence.
...
- **Affected Code**: `AosWorkspaceBootstrapper` (Gmsd.Aos), `WorkspaceService` (Gmsd.Web), `WorkspaceRepository` (Gmsd.Data).
