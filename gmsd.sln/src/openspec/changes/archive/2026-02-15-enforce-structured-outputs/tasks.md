...
- [x] Define `PhasePlan` JSON schema in `Gmsd.Aos.Contracts`.
- [x] Define `FixPlan` JSON schema in `Gmsd.Aos.Contracts`.
- [x] Define `CommandProposal` JSON schema in `Gmsd.Aos.Contracts`.
- [x] Add schema validation tests in `Gmsd.Aos.Tests`.
