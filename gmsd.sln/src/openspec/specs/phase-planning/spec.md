...
- Coordinate context gathering â†’ planning â†’ assumption listing
...
- **THEN** it executes context gatherer â†’ planner â†’ assumption lister sequence and returns success with tasks created
