...
- `map.json` â€” high-level codebase overview and metadata
- `stack.json` â€” detected technology stack
- `architecture.json` â€” architectural patterns and boundaries
- `structure.json` â€” directory/file structure with statistics
- `conventions.json` â€” coding conventions and patterns
- `testing.json` â€” test structure and coverage information
- `integrations.json` â€” external integration points
- `concerns.json` â€” cross-cutting concerns and complexity hotspots
- `cache/symbols.json` â€” symbol index for fast lookup
- `cache/file-graph.json` â€” file dependency graph
