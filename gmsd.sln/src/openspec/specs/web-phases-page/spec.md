...
Defines the current implemented Phases UI in `Gmsd.Web` for listing phases derived from the roadmap and inspecting phase details with planning entry points.

- **Lives in:** `Gmsd.Web/Pages/Phases/*`, `.aos/spec/roadmap.json`, `.aos/state/state.json`
