...
The system SHALL provide an `IRoadmapper` interface in `Gmsd.Agents.Workflows.Planning` that transforms a validated project specification into a structured execution roadmap.
...
- Validate generated roadmap against schema `gmsd:aos:schema:roadmap:v1`
...
- Include required schema identifiers (`gmsd:aos:schema:*:v1`)
...
The state MUST validate against schema `gmsd:aos:schema:state:v1`.
...
The event MUST validate against schema `gmsd:aos:schema:event:v1`.
...
- `Gmsd.Agents/Workflows/Planning/IRoadmapper.cs`
- `Gmsd.Agents/Workflows/Planning/Roadmapper.cs`
- `Gmsd.Agents/Workflows/Planning/IRoadmapGenerator.cs`
- `Gmsd.Agents/Workflows/Planning/RoadmapGenerator.cs`
- `Gmsd.Agents/Workflows/Planning/RoadmapperHandler.cs`
- `Gmsd.Agents/Models/Runtime/RoadmapContext.cs`
- `Gmsd.Agents/Models/Results/RoadmapResult.cs`
- `Gmsd.Agents/Models/Contracts/MilestoneItem.cs`
- `Gmsd.Agents/Models/Contracts/PhaseItem.cs`

### Testing

- Unit tests: `tests/Gmsd.Agents.Tests/Workflows/Planning/RoadmapGeneratorTests.cs`
- Unit tests: `tests/Gmsd.Agents.Tests/Workflows/Planning/RoadmapperTests.cs`
- Integration tests: `tests/Gmsd.Agents.Tests/Workflows/Planning/RoadmapperIntegrationTests.cs`
