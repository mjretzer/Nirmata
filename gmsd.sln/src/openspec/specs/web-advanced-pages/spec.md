# web-advanced-pages Specification

## Purpose

Defines the current implemented advanced operational pages in `Gmsd.Web` for engine/agent workflows (Fix planning, Codebase intelligence, Context packs, State/Events, Checkpoints, Validation).

- **Lives in:** `Gmsd.Web/Pages/Fix/*`, `Gmsd.Web/Pages/Codebase/*`, `Gmsd.Web/Pages/Context/*`, `Gmsd.Web/Pages/State/*`, `Gmsd.Web/Pages/Checkpoints/*`, `Gmsd.Web/Pages/Validation/*`
- **Owns:** UI routing and read/write interaction with workspace artifacts for operational workflows
- **Does not own:** Canonical engine artifact contracts or orchestrator control-loop semantics
## Requirements
### Requirement: Fix Planning Page (Repair Loop)
The Gmsd.Web project SHALL provide a `/Fix` page displaying the repair loop state and fix planning actions.
...
The Gmsd.Web project SHALL provide a `/Codebase` page for viewing and triggering codebase intelligence operations.
...
The Gmsd.Web project SHALL provide a `/Context` page for managing context packs.
...
The Gmsd.Web project SHALL provide a `/State` page for viewing operational state and event history.
...
The Gmsd.Web project SHALL provide a `/Checkpoints` page for managing run continuity.
...
The Gmsd.Web project SHALL provide a `/Validation` page for workspace maintenance operations.
...
The Gmsd.Web project SHALL update the shared layout to include navigation for all new advanced pages.
