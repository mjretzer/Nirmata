...
Defines the current implemented Orchestrator UI in `Gmsd.Web` for submitting commands/freeform input to the orchestration system and rendering structured results with safety rails context.

- **Lives in:** `Gmsd.Web/Pages/Orchestrator/*`, `Gmsd.Web/AgentRunner/WorkflowClassifier*`
