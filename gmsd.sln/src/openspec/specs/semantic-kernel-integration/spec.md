...
- `Agents:SemanticKernel:Provider` â€” provider identifier (`openai`, `azureopenai`, `ollama`, `anthropic`)
- `Agents:SemanticKernel:OpenAi:*` â€” OpenAI-specific settings
- `Agents:SemanticKernel:AzureOpenAi:*` â€” Azure OpenAI-specific settings
- `Agents:SemanticKernel:Ollama:*` â€” Ollama-specific settings
- `Agents:SemanticKernel:Anthropic:*` â€” Anthropic-specific settings
