...
Defines end-to-end verification conventions and expected checks for the platform.

- **Lives in:** `tests/*` and `.aos/fixtures/**` (as applicable)
- **Owns:** E2E verification expectations and repeatable execution patterns
- **Does not own:** Unit-level implementation details
## Requirements
### Requirement: E2E-VRF-001 â€” Init workspace verification
...
### Requirement: E2E-VRF-002 â€” Init idempotency
...
### Requirement: E2E-VRF-003 â€” Validation gates after init
...
### Requirement: E2E-VRF-004 â€” Full control loop execution
...
- **When** `aos init` â†’ seed project â†’ roadmap generate â†’ validate
...
### Requirement: E2E-VRF-005 â€” Test categorization
