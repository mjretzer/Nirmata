namespace Gmsd.Aos.Public.Catalogs;

/// <summary>
/// Stable tool ID constants for the engine.
/// Uses prefixed format to avoid collisions: "gmsd:aos:tool:{category}:{operation}" for internal tools,
/// "mcp:{server}:{tool}" for MCP tools.
/// </summary>
public static class ToolIds
{
    // Prefix constants
    public const string InternalPrefix = "gmsd:aos:tool:";
