using Gmsd.Aos.Public.Configuration;
...
namespace Gmsd.Aos.Public.Composition;

/// <summary>
/// Extension methods for registering GMSD AOS services with dependency injection.
/// </summary>
public static class ServiceCollectionExtensions
{
    /// <summary>
    /// Adds GMSD AOS services to the dependency injection container.
    /// </summary>
    ...
    /// </para>
    /// </remarks>
    public static IServiceCollection AddGmsdAos(
        this IServiceCollection services,
        IConfiguration configuration)
    {
        // Bind configuration
        services.Configure<AosOptions>(configuration.GetSection("GmsdAos"));
    ...
    /// <summary>
    /// Adds GMSD AOS services to the dependency injection container using a specific repository root path.
    /// </summary>
    /// <param name="services">The service collection to add services to.</param>
