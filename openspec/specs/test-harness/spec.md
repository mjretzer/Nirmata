...
## Purpose
TBD - created by archiving change 2026-02-07-add-aos-e2e-verification-projects. Update Purpose after archive.
## Requirements
### Requirement: TST-HRN-001 — Disposable fixture repositories
...
### Requirement: TST-HRN-002 — AOS test harness API
...
### Requirement: TST-HRN-003 — CLI and in-proc execution modes
