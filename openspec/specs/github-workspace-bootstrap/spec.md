# github-workspace-bootstrap Specification

## Purpose
Connect GitHub during first workspace creation so the system can create or reuse a repository and configure the local `origin` automatically.
