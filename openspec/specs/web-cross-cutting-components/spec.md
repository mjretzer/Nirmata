...
The Web Cross-Cutting Components capability provides global UI components that deliver consistent UX patterns across all GMSD Web pages, including command palette navigation, workspace status display, artifact linking, and toast notifications.
...
- **GIVEN** the user is on any GMSD Web page
...
- **GIVEN** JavaScript calls `window.GmsdToasts.error("Connection failed")`
...
### Files
- `Gmsd.Web/wwwroot/js/command-palette.js`
- `Gmsd.Web/Pages/Shared/_WorkspaceBadge.cshtml`
- `Gmsd.Web/wwwroot/js/artifact-links.js`
- `Gmsd.Web/wwwroot/js/toasts.js`
- `Gmsd.Web/Helpers/ToastHelper.cs`
- `Gmsd.Web/wwwroot/css/site.css` (component styles)
