...
The system SHALL provide an `IAtomicGitCommitter` interface in `Gmsd.Agents.Execution.Execution.AtomicGitCommitter` that executes atomic Git commits scoped to task-defined file patterns.
