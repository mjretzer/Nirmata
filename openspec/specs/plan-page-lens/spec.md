# plan-page-lens Specification

## Purpose
Define the deterministic route resolution, canonical data sourcing, and state handling contract for the Plan page's AOS spec filesystem lenses.
