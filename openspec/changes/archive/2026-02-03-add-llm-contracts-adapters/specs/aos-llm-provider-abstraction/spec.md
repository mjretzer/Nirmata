...
- Load templates from embedded resources in `Gmsd.Aos.Resources.Prompts`
...
- **GIVEN** an embedded resource exists at `Gmsd.Aos.Resources.Prompts.planning.task-breakdown.v1.prompt.txt`
