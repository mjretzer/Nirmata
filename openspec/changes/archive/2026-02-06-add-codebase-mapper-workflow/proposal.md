...
- **Impact on Gmsd.Agents**: New `Execution/Brownfield/CodebaseMapper/**` directory structure

## Impact
- **Affected specs:** NEW capability `codebase-mapping`
- **Affected code:** 
  - `Gmsd.Agents/Execution/Brownfield/CodebaseMapper/CodebaseScanner/**`
  - `Gmsd.Agents/Execution/Brownfield/CodebaseMapper/SymbolCacheBuilder/**`
  - `Gmsd.Agents/Execution/Brownfield/CodebaseMapper/FileGraphBuilder/**`
  - `Gmsd.Agents/Execution/Brownfield/CodebaseMapper/MapValidator/**`
