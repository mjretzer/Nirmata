...
The system SHALL write a run manifest at `.aos/evidence/runs/<run-id>/manifest.json` for each run.
...
- **THEN** `.aos/evidence/runs/<run-id>/manifest.json` exists and enumerates each output with its SHA-256 hash
