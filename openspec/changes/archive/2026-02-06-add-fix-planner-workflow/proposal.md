...
## What Changes
- **ADD** `IFixPlanner` interface and implementation in `Gmsd.Agents.Execution.FixPlanner`
...
- **Affected code:**
  - `Gmsd.Agents/Execution/FixPlanner/**` (new)
  - `Gmsd.Agents/Execution/ControlPlane/FixPlannerHandler.cs` (new)
  - `Gmsd.Agents/Execution/ControlPlane/GatingEngine.cs` (MODIFIED for routing)
- **Workspace outputs:**
