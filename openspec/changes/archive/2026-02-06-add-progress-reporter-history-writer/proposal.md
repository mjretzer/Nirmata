...
- **ADDED** `ProgressReporter` class in `Gmsd.Agents/Execution/Continuity/ProgressReporter/` to generate deterministic progress reports from current state
- **ADDED** `HistoryWriter` class in `Gmsd.Agents/Execution/Continuity/HistoryWriter/` to append narrative summaries keyed by RUN/TSK with evidence references
...
- **Affected code:** `Gmsd.Agents/Execution/Continuity/ProgressReporter/**`, `Gmsd.Agents/Execution/Continuity/HistoryWriter/**`
