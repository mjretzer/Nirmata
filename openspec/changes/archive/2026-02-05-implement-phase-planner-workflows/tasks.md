...
- [x] 1.1 Create `IPhaseContextGatherer` interface in `Gmsd.Agents/Execution/Planning/PhasePlanner/ContextGatherer/`
- [x] 1.2 Create `IPhasePlanner` interface in `Gmsd.Agents/Execution/Planning/PhasePlanner/`
- [x] 1.3 Create `IPhaseAssumptionLister` interface in `Gmsd.Agents/Execution/Planning/PhasePlanner/Assumptions/`
