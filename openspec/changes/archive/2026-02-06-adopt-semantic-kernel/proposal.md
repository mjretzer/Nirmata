...
- Update `Gmsd.Agents.csproj` to reference `Microsoft.SemanticKernel` packages
...
- **Affected code**: `Gmsd.Agents/Execution/ControlPlane/Llm/**`, `Gmsd.Agents/Configuration/**`, workflow classes using LLM
