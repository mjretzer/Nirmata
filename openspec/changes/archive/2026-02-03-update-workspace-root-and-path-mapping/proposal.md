...
- **Affected code** (expected during apply stage):
  - `Gmsd.Aos/Composition/Program.cs` (repo root discovery behavior)
  - `Gmsd.Aos/Engine/Workspace/**` (bootstrap contract alignment)
  - `Gmsd.Aos/Engine/Validation/**` (layer naming + defaults)
  - `Gmsd.Aos/Engine/Paths/AosPathRouter.cs` (canonical contract paths)
  - `Gmsd.Aos/Public/IWorkspace.cs` (public surface expansion)
