...
- **ADDED** `IRoadmapper` interface and `Roadmapper` implementation in `Gmsd.Agents.Execution.Planning.Roadmapper`
...
- **Affected code:**
  - `Gmsd.Agents/Execution/Planning/Roadmapper/**` (new)
  - `Gmsd.Agents/Execution/Orchestrator/GatingEngine.cs` (context update)
  - `Gmsd.Aos/Contracts/State/` (event type catalog)
