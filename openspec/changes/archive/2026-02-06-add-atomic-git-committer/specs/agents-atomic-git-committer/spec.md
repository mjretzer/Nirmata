...
The system SHALL provide an `IAtomicGitCommitter` interface in `Gmsd.Agents.Execution.Execution.AtomicGitCommitter` that performs scope-intersection staging and deterministic committing.
