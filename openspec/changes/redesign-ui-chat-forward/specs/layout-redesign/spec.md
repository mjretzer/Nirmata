...
## Purpose
Redesign the application layout from a traditional navigation-based structure to a chat-centric, three-panel layout optimized for conversational interaction.
...
### Requirement: Navigation Pattern (MODIFIED from web-razor-pages)

**Original**: Traditional top navigation with 15+ nav items  
**New**: Chat-driven navigation with contextual sidebar
