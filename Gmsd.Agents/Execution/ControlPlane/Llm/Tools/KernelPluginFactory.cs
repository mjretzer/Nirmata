...
/// <summary>
/// Factory for creating Semantic Kernel plugins from GMSD tool collections.
...
public static class KernelPluginFactory
{
    ...
    public static KernelPlugin CreateFromTools(IEnumerable<(ITool Tool, ToolDescriptor Descriptor)> tools)
    {
        ...
        if (toolList.Count == 0)
        {
            return Microsoft.SemanticKernel.KernelPluginFactory.CreateFromFunctions("gmsd_tools", []);
        }
