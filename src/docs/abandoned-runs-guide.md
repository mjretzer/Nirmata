...
Get-EventLog -LogName Application -Source nirmataService | 
...
**Prevention:**
- Enable crash dumps: `set nirmata_DUMP_ON_CRASH=1`
...
2. Check background task is running: `Get-Service nirmataService`
