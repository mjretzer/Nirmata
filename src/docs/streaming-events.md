...
The nirmata streaming API emits typed events over Server-Sent Events (SSE) to provide real-time visibility into the orchestration flow. This document describes the event contract for the v2 streaming endpoint.
...
- API Controller: `nirmata.Web/Controllers/ChatStreamingController.cs`
- Tool Calling Adapter: `nirmata.Web/AgentRunner/ToolCallingEventAdapter.cs`
- nirmata.Agents README: `nirmata.Agents/README.md`
