...
This document describes the tool calling protocol implemented in nirmata, which enables multi-step conversational tool use with LLMs.
...
- `nirmata.Agents.Execution.ToolCalling` namespace
