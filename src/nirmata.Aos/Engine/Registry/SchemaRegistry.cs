...
namespace nirmata.Aos.Engine.Registry;
...
internal sealed class SchemaRegistry : ISchemaRegistry
{
    ...
    {
        var registryPath = Path.Combine(repositoryRootPath, ".aos", "schemas", "registry.json");
        ...
        return AosLocalSchemaRegistryLoader.LoadLocalSchemas(
            repositoryRootPath,
            enforceRequiredArtifactContracts: true);
    }
}
