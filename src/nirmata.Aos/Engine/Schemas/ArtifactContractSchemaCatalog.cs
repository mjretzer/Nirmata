...
{
    internal const string TaskPlanSchemaId = "nirmata:aos:schema:task-plan:v1";
    internal const string CommandProposalSchemaId = "nirmata:aos:schema:command-proposal:v1";
