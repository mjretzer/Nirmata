...
using nirmata.Aos.Engine.Evidence.Runs;
using nirmata.Aos.Engine.Evidence.Calls;
using nirmata.Aos.Engine.Evidence.Commands;
using nirmata.Aos.Engine.Evidence.ExecutePlan;
using nirmata.Aos.Engine.Locks;
...
using nirmata.Aos.Engine.Cache;
...
internal static class Program
{
    ...
    private static string CreateCheckpoint(string aosRootPath)
    {
        ...
        _ = nirmata.Aos.Engine.StateTransitions.AosStateTransitionEngine.ValidateTransitionOrThrow(
            aosRootPath,
            nirmata.Aos.Engine.StateTransitions.AosStateTransitionTable.Kinds.CheckpointCreated
        );
        ...
        stateStore.AppendEvent(new CheckpointEventDocument(
            SchemaVersion: 1,
            Kind: nirmata.Aos.Engine.StateTransitions.AosStateTransitionTable.Kinds.CheckpointCreated,
            CheckpointId: checkpointId,
    ...
    private static void RestoreCheckpoint(string aosRootPath, string checkpointId)
    {
        ...
        _ = nirmata.Aos.Engine.StateTransitions.AosStateTransitionEngine.ValidateTransitionOrThrow(
            aosRootPath,
            nirmata.Aos.Engine.StateTransitions.AosStateTransitionTable.Kinds.CheckpointRestored,
            checkpointId
        );
        ...
        stateStore.AppendEvent(new CheckpointEventDocument(
            SchemaVersion: 1,
            Kind: nirmata.Aos.Engine.StateTransitions.AosStateTransitionTable.Kinds.CheckpointRestored,
            CheckpointId: checkpointId,
            CheckpointContractPath: $".aos/state/checkpoints/{checkpointId}/checkpoint.json",
            SnapshotContractPath: $".aos/state/checkpoints/{checkpointId}/state.json",
            StateContractPath: AosStateStore.StateContractPath
