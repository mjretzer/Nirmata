...
The nirmata codebase currently has **dual LLM integration paths** that create maintenance burden and confusion:
...
- **nirmata.Agents/Execution/ControlPlane/Llm/**:
...
| **Affected code** | `nirmata.Agents/Execution/ControlPlane/Llm/**, configuration |
