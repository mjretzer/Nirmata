...
- [x] **Create SemanticKernelLlmProvider adapter class**
   - File: `nirmata.Agents/Execution/ControlPlane/Llm/Adapters/SemanticKernelLlmProvider.cs`
...
- [x] **Mark ILlmProvider contract types as obsolete**
   - Files:
     - `nirmata.Agents/Execution/ControlPlane/Llm/Contracts/ILlmProvider.cs`
     - `nirmata.Agents/Execution/ControlPlane/Llm/Contracts/LlmCompletionRequest.cs`
     - `nirmata.Agents/Execution/ControlPlane/Llm/Contracts/LlmCompletionResponse.cs`
     - `nirmata.Agents/Execution/ControlPlane/Llm/Contracts/LlmMessage.cs`
     - `nirmata.Agents/Execution/ControlPlane/Llm/Contracts/LlmDelta.cs`
     - `nirmata.Agents/Execution/ControlPlane/Llm/Contracts/LlmProviderOptions.cs`
     - `nirmata.Agents/Execution/ControlPlane/Llm/Contracts/LlmToolCall.cs`
     - `nirmata.Agents/Execution/ControlPlane/Llm/Contracts/LlmToolDefinition.cs`
...
- [x] **Remove custom provider adapter implementations**
   - Delete files:
     - `nirmata.Agents/Execution/ControlPlane/Llm/Adapters/OpenAi/OpenAiLlmAdapter.cs`
     - `nirmata.Agents/Execution/ControlPlane/Llm/Adapters/Anthropic/AnthropicLlmAdapter.cs`
     - `nirmata.Agents/Execution/ControlPlane/Llm/Adapters/AzureOpenAi/AzureOpenAiLlmAdapter.cs`
     - `nirmata.Agents/Execution/ControlPlane/Llm/Adapters/Ollama/OllamaLlmAdapter.cs`
...
- [x] **Update AddLlmProvider to use Semantic Kernel**
   - File: `nirmata.Agents/Configuration/LlmServiceCollectionExtensions.cs`
...
- [x] **Update appsettings.json example**
   - File: `nirmata.Agents/appsettings.json`
...
- [x] **Create unit tests for SemanticKernelLlmProvider**
   - File: `tests/nirmata.Agents.Tests/Execution/ControlPlane/Llm/SemanticKernelLlmProviderTests.cs`
...
- [x] **Update integration tests for DI resolution**
   - File: `tests/nirmata.Agents.Tests/Configuration/LlmProviderDiTests.cs` (exists)
