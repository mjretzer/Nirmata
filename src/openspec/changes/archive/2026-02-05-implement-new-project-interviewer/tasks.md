...
- [x] 1.1 Create `nirmata.Agents/Execution/Planning/NewProjectInterviewer/` directory structure
...
- [x] 2.4 Add validation that generated spec conforms to `nirmata:aos:schema:project:v1`
