## 1. Implementation
- [x] 1.1 Create nirmataDbContext with Project and Step DbSets
...
- [x] 1.7 Configure SQLite connection string (Data Source=sqllitedb/nirmata.db)

## 2. Validation
- [x] 2.1 Verify `dotnet build` succeeds
- [x] 2.2 Verify migration files generated in `nirmata.Data/Migrations/`
