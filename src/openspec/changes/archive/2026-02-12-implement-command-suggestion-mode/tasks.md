...
1. **Create CommandProposal model**
   ...
   - Add to `nirmata.Agents/Execution/Preflight/CommandSuggestion/`
...
5. **Add DI registration for ICommandSuggester**
   ...
   - Wire up in both `AddnirmataAgents` overloads
...
7. **Add command.suggested event type**
   ...
   - Add to `nirmata.Agents/Observability/Streaming/Events/`
