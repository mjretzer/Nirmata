...
- **Affected code (implementation stage)**
  - `nirmata.Aos/Composition/Program.cs` (new `cache` command group)
  - New engine cache module (e.g., `nirmata.Aos/Engine/Cache/**`) to implement clear/prune behaviors
  - Tests under `tests/nirmata.Aos.Tests` for cache clear/prune + lock contention behavior
