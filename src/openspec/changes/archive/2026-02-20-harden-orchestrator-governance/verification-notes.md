...
**Implementation:**
- Created `ISecretStore` interface in `nirmata.Aos/Contracts/Secrets/ISecretStore.cs`
...
**Files Created:**
- `nirmata.Aos/Contracts/Secrets/ISecretStore.cs`
- `nirmata.Aos/Contracts/Secrets/SecretNotFoundException.cs`

### 5.2 Windows Credential Manager Backend
**Status:** ✅ COMPLETED

**Implementation:**
- Created `WindowsCredentialManagerSecretStore` in `nirmata.Aos/Engine/Secrets/WindowsCredentialManagerSecretStore.cs`
- Uses Windows Credential Manager API (Advapi32.dll) for secure storage
- Implements all `ISecretStore` operations
- Secrets prefixed with `nirmata_` for organization
...
**Files Created:**
- `nirmata.Aos/Engine/Secrets/WindowsCredentialManagerSecretStore.cs`

### 5.3 Mock Secret Store for Testing
**Status:** ✅ COMPLETED

**Implementation:**
- Created `MockSecretStore` in `nirmata.Aos/Engine/Secrets/MockSecretStore.cs`
...
**Files Created:**
- `nirmata.Aos/Engine/Secrets/MockSecretStore.cs`

### 5.4 Configuration Schema with Secret References
**Status:** ✅ COMPLETED

**Implementation:**
- Created `SecretConfigurationResolver` in `nirmata.Aos/Engine/Secrets/SecretConfigurationResolver.cs`
...
- Created `SecretConfigurationOptions` in `nirmata.Aos/Configuration/SecretConfigurationOptions.cs`
- Created `SecretAwareConfigurationProvider` in `nirmata.Aos/Configuration/SecretAwareConfigurationProvider.cs`
- Created `SecretServiceCollectionExtensions` in `nirmata.Aos/Composition/SecretServiceCollectionExtensions.cs`

**Files Created:**
- `nirmata.Aos/Engine/Secrets/SecretConfigurationResolver.cs`
- `nirmata.Aos/Configuration/SecretConfigurationOptions.cs`
- `nirmata.Aos/Configuration/SecretAwareConfigurationProvider.cs`
- `nirmata.Aos/Composition/SecretServiceCollectionExtensions.cs`

## Test Coverage

**Unit Tests Created:**
- `tests/nirmata.Aos.Tests/Engine/Secrets/MockSecretStoreTests.cs` (12 tests)
- `tests/nirmata.Aos.Tests/Engine/Secrets/SecretConfigurationResolverTests.cs` (12 tests)
- `tests/nirmata.Aos.Tests/Configuration/SecretAwareConfigurationProviderTests.cs` (7 tests)
...
**Build Results:**
- ✅ `nirmata.Aos` project: SUCCESS
- ✅ `nirmata.Aos.Tests` project: SUCCESS
...
**Implementation:**
- Created `SecretMigrationUtility` in `nirmata.Aos/Engine/Secrets/SecretMigrationUtility.cs`
...
**Files Created:**
- `nirmata.Aos/Engine/Secrets/SecretMigrationUtility.cs`
...
**Implementation:**
- Created `SecretMigrationUtilityTests` in `tests/nirmata.Aos.Tests/Engine/Secrets/SecretMigrationUtilityTests.cs`
...
**Files Created:**
- `tests/nirmata.Aos.Tests/Engine/Secrets/SecretMigrationUtilityTests.cs`

### 5.12 Add Integration Tests for Secret Injection into LLM Calls
**Status:** ✅ COMPLETED

**Implementation:**
- Created `SemanticKernelSecretInjectionTests` in `tests/nirmata.Agents.Tests/Configuration/SemanticKernelSecretInjectionTests.cs`
- Created `LlmProviderSecretInjectionTests` in `tests/nirmata.Agents.Tests/Execution/ControlPlane/Llm/LlmProviderSecretInjectionTests.cs`
...
**Files Created:**
- `tests/nirmata.Agents.Tests/Configuration/SemanticKernelSecretInjectionTests.cs`
- `tests/nirmata.Agents.Tests/Execution/ControlPlane/Llm/LlmProviderSecretInjectionTests.cs`
...
```bash
# Build the project
dotnet build nirmata.Aos/nirmata.Aos.csproj -c Release

# Run all hardening feature tests
dotnet test tests/nirmata.Aos.Tests/nirmata.Aos.Tests.csproj -c Release
...
**Modified Code Files:**
- `nirmata.Aos/Composition/Program.cs` (fixed FileNotFoundException handling in resume command)
- `nirmata.Aos/Engine/Errors/AosErrorMapper.cs` (error mapping)
