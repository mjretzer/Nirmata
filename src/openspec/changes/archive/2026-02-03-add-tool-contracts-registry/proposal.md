...
- **Affected code paths:**
  - `nirmata.Aos/Contracts/Tools/**` - tool contract interfaces and models
  - `nirmata.Aos/Tools/**` - tool descriptor and metadata implementations
  - `nirmata.Aos/Registry/**` - tool registry implementation
  - `nirmata.Aos/Public/Catalogs/**` - `ToolIds.cs` for stable tool IDs
  - `nirmata.Aos/Mcp/**` - MCP adapter implementation
