...
The system SHALL provide an `IRoadmapModifier` interface in `nirmata.Agents.Execution.Planning` that enables safe insertion, removal, and renumbering of roadmap phases.
