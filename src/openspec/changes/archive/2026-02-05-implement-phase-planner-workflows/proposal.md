...
## What Changes
- Add `IPhasePlanner` interface and `PhasePlanner` implementation in `nirmata.Agents/Execution/Planning/PhasePlanner/`
- Add `IPhaseContextGatherer` interface and implementation in `nirmata.Agents/Execution/Planning/PhasePlanner/ContextGatherer/`
- Add `IPhaseAssumptionLister` interface and implementation in `nirmata.Agents/Execution/Planning/PhasePlanner/Assumptions/`
...
- **Affected code:**
  - `nirmata.Agents/Execution/Planning/PhasePlanner/**` (new)
  - `nirmata.Agents/Workflows/Planning/` (may add handler integration)
