...
**Files Modified:**
- `nirmata.Agents/Execution/Planning/PhasePlanner/PhasePlanner.cs` - Added diagnostic creation on schema validation failure
- `nirmata.Agents/Execution/FixPlanner/FixPlanner.cs` - Added diagnostic creation on schema validation failure
...
**Implementation:**
- Created `LlmRetryHandler` class in `nirmata.Agents/Execution/ControlPlane/Llm/LlmRetryHandler.cs`
...
**Files Created:**
- `nirmata.Agents/Execution/ControlPlane/Llm/LlmRetryHandler.cs`
...
- Diagnostics follow canonical schema: `nirmata:aos:schema:diagnostic:v1`
...
**Files Modified:**
- `nirmata.Agents/Execution/Planning/PhasePlanner/PhasePlanner.cs` - Added `CreateDiagnosticForLlmValidationFailure()`
- `nirmata.Agents/Execution/FixPlanner/FixPlanner.cs` - Added `CreateDiagnosticForLlmValidationFailure()`
...
**Files Created:**
- `tests/nirmata.Agents.Tests/Execution/Planning/PhasePlannerLlmStructuredOutputTests.cs`
...
**Files Created:**
- `tests/nirmata.Agents.Tests/Execution/FixPlanner/FixPlannerLlmStructuredOutputTests.cs`
...
**Files Created:**
- `tests/nirmata.Agents.Tests/Verification/UatVerifierLlmValidationTests.cs`
