...
This document describes the process for migrating existing nirmata workspaces from old artifact formats to the new unified canonical schemas defined in the unify-data-contracts change.
...
### CLI Command: `nirmata migrate-schemas`

```bash
nirmata migrate-schemas --workspace-path <path> [--dry-run] [--backup]
```
...
{
  "schemaVersion": 1,
  "schemaId": "nirmata:aos:schema:verifier-output:v1",
  "taskId": "TSK-0001",
  "status": "passed",
  "checks": [],
  "timestamp": "2026-02-19T18:07:00Z"
...
{
  "schemaVersion": 1,
  "schemaId": "nirmata:aos:schema:fix-plan:v1",
  "taskId": "TSK-0001",
  "fixes": [],
  "verificationSteps": [],
  "timestamp": "2026-02-19T18:07:00Z"
...
{
  "schemaVersion": 1,
  "schemaId": "nirmata:aos:schema:phase-plan:v1",
  "tasks": [],
  "fileScopes": [{"path": "src/"}],
  "verificationSteps": [],
  "timestamp": "2026-02-19T18:07:00Z"
...
- [ ] Run migration in dry-run mode: `nirmata migrate-schemas --workspace-path <path> --dry-run`
- [ ] Review dry-run output for any errors
- [ ] Run actual migration: `nirmata migrate-schemas --workspace-path <path>`
...
```bash
# Restore from backup
nirmata restore-backup --backup-path path/to/backup-20260219-180700
```
...
4. Contact the nirmata team with:
   - Workspace path
