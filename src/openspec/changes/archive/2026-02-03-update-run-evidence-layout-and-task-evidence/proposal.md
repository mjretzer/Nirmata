...
- **Affected code (implementation stage)**:
  - `nirmata.Aos/Engine/Evidence/**` (run evidence writers and new task-evidence writer)
  - `nirmata.Aos/Engine/Validation/**` (workspace validation rules)
  - `nirmata.Aos/Resources/Schemas/**` (schemas for new artifacts)
