...
## Purpose
Define the dependency injection composition root for the Agents (Plane) layer, enabling hosts to wire up all Plane and Engine services via a single extension method.
