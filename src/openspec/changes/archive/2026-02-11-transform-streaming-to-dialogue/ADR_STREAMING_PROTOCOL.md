...
**Status**: Accepted  
**Date**: 2026-02-11  
**Author**: nirmata Architecture Team  
...
The nirmata system uses Server-Sent Events (SSE) to stream responses from the agent orchestrator to the web UI. The current implementation follows a "job runner" pattern where:
