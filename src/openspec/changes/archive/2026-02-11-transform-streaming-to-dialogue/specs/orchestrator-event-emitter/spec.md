...
Specifies the modifications to the nirmata Agents orchestrator to emit typed streaming events during classification, gating, and phase execution. This enables transparent observation of the orchestrator's decision-making process.
