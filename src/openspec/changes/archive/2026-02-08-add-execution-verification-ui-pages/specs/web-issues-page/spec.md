...
## Purpose
Provides a web interface for issue management, including filtered issue lists, detailed issue views with reproduction steps, and actions for routing issues to fix plans or marking them resolved/deferred.
