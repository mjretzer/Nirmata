...
- **Affected code (expected)**:
  - `nirmata.Aos/Engine/Stores/AosSpecStore.cs`
  - `nirmata.Aos/Engine/Paths/AosPathRouter.cs`
  - `nirmata.Aos/Engine/Repair/AosIndexRepairer.cs`
  - `nirmata.Aos/Engine/Validation/AosWorkspaceValidator.cs` (as needed for updated contract path expectations)
  - `tests/nirmata.Aos.Tests/**` (routing + repair determinism + CRUD flows)
