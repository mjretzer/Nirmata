...
The system SHALL provide an `ITaskExecutor` interface in `nirmata.Agents.Execution.Execution.TaskExecutor` that executes task plans sequentially with strict file scoping and evidence capture.
