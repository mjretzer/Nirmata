...
The system SHALL provide an `ISubagentOrchestrator` interface in `nirmata.Agents.Execution.Execution.SubagentRuns` that manages per-task subagent lifecycle with fresh context and bounded context packs.
