...
- Add missing solution projects from the nirmata structure baseline (Web, AOS, Agents, Windows Service, Windows Service API) without altering existing project names.
...
- Affected code: `nirmata.Web`, `nirmata.Aos`, `nirmata.Agents`, `nirmata.Windows.Service`, `nirmata.Windows.Service.Api`, `nirmata.Api`, `nirmata.Services`, `nirmata.Data`, `nirmata.Data.Dto`, `nirmata.Common`, solution build/test pipeline
