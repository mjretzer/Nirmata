...
- Decision: Keep mapping in `nirmata.Data.Mapping` using AutoMapper profiles.
...
- Decision: Preserve existing project names and namespaces (`nirmata.Api`, `nirmata.Services`, `nirmata.Data`, `nirmata.Data.Dto`, `nirmata.Common`) while extending capabilities.
