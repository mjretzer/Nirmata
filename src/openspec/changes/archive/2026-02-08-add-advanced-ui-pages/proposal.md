...
- **Affected code:** `nirmata.Web/Pages/**` (new pages), `nirmata.Web/Pages/Shared/_Layout.cshtml` (nav updates)
- **Dependencies:** Requires `ICheckpointManager`, `IEventStore`, `IStateStore`, codebase mapping artifacts from `nirmata.Aos`
