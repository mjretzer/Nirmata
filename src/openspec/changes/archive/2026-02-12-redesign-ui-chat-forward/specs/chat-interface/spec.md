...
## Purpose
Provide a conversational interface as the primary interaction surface for nirmata, enabling users to accomplish tasks through natural language commands with rich, inline response rendering.
