...
## Sequencing
This change builds on the existing `nirmata.Web` project and leverages the `WorkflowClassifier` for in-process agent execution. The existing Command Center chat implementation will be evolved and promoted to the primary interface pattern.
