...
This document defines the configuration schema for Anthropic provider support in nirmata.

## Configuration Structure

```
nirmataAgents:SemanticKernel:
  Provider: "Anthropic"
  Anthropic:
    ApiKey: "sk-ant-..."
...
Located in `nirmata.Agents/Configuration/SemanticKernelOptions.cs`:
...
public void ValidConfiguration_Loads_Successfully()
{
    ...
    var options = config.GetSection("nirmataAgents:SemanticKernel")
