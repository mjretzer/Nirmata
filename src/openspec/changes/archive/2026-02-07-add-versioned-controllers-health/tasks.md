...
### 1.1 Base Controller
- [x] 1.1.1 Create `nirmata.Api/Controllers/nirmataController.cs` base class
- [x] 1.1.2 Add common response helper methods (OkResult, NotFoundResult, etc.)
- [x] 1.1.3 Refactor `ProjectController` to inherit from `nirmataController`

### 1.2 Health Controller
- [x] 1.2.1 Create `nirmata.Api/Controllers/HealthController.cs`
...
- [x] 2.1.1 Add health endpoint test to `nirmata.Api.Tests/ProjectEndpointsTests.cs` (or create `HealthEndpointsTests.cs`)
...
- [x] 3.1 Build succeeds: `dotnet build nirmata.slnx`
- [x] 3.2 All tests pass: `dotnet test`
- [x] 3.3 Local run: `dotnet run --project nirmata.Api` starts successfully
