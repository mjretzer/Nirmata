...
- [x] 2.1 Expand `nirmata.Aos/Resources/Schemas/context-pack.schema.json` to model a self-contained pack:
  - pack id (`PCK-####`)
...
- [x] 4.1 Add pack build API in `nirmata.Aos/Context/**` (inputs: mode + id + budget; output: pack object)
