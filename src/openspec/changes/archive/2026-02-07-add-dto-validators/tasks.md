...
- [x] 1.1 Add FluentValidation (or chosen validation library) package to `nirmata.Data.Dto.csproj`
- [x] 1.2 Add FluentValidation.AspNetCore package to `nirmata.Api.csproj` for pipeline integration
- [x] 1.3 Create `nirmata.Data.Dto/Validators/` folder structure matching `Requests/` hierarchy
...
## 3. API Integration
- [x] 3.1 Register validators in `nirmata.Api` DI container (`AddFluentValidationAutoValidation()`)
