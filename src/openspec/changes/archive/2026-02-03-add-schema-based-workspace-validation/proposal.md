...
- **Affected code (planned)**:
  - `nirmata.Aos/Engine/Schemas/**` (schema registry by `$id`)
  - `nirmata.Aos/Engine/Validation/**` (schema-based validation + normalized reporting)
  - `nirmata.Aos/Public/Catalogs/SchemaIds.cs` and `nirmata.Aos/Public/Catalogs/ArtifactKinds.cs` (fill stubs)
  - `nirmata.Aos/Resources/Schemas/**` (additional `*.schema.json`)
- **Dependencies**:
