...
- [x] 2.4 Fill `nirmata.Aos.Public.Catalogs.SchemaIds` with canonical `$id` constants
...
- [x] 3.5 Fill `nirmata.Aos.Public.Catalogs.ArtifactKinds` with stable kind strings aligned to routing rules
