...
**Files:** `nirmata.Web/Models/Streaming/StreamingEvent.cs`
...
**Files:** `nirmata.Agents/Execution/Context/IEventSink.cs` (or equivalent)
...
**Files:** `nirmata.Web/Models/Streaming/LegacyEventAdapter.cs`
...
**Depends On:** Task 1.1
**Files:** `nirmata.Agents/Execution/ControlPlane/StreamingOrchestrator.cs`
**Validation:** 
...
**Files:** `nirmata.Web/AgentRunner/StreamingToolEventSink.cs`
**Validation:**
...
**Files:** `nirmata.Web/Models/Streaming/StreamingOrchestrator.cs`
**Validation:**
...
**Files:** `tests/nirmata.Agents.Tests/E2E/StreamingDialogueTests.cs` (create if needed)
**Validation:**
...
**Depends On:** Task 4.1
**Files:** `tests/nirmata.Agents.Tests/E2E/StreamingDialogueTests.cs`
**Validation:**
...
**Files:** `tests/nirmata.Web.Tests/ChatStreamingControllerTests.cs` (create if needed)
**Validation:**
...
**Files:** `nirmata.Web/Controllers/ChatStreamingController.cs` (XML comments)
**Validation:**
