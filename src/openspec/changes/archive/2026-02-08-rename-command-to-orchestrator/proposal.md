...
- **Affected code**: 
  - `nirmata.Web/Pages/Command/` → `nirmata.Web/Pages/Orchestrator/`
  - `nirmata.Web/AgentRunner/WorkflowClassifier.cs` (namespace references if any)
