...
Evidence-writing logic for this milestone SHOULD live under `nirmata.Aos/Engine/Evidence/` (namespace `nirmata.Aos.Engine.Evidence`) to keep `.aos/evidence/**` filesystem concerns inside the engine layer.
