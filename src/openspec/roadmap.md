# nirmata.sln — Massive Solution Roadmap (Engine / Plane / Product)

This roadmap is organized into three top-level tracks:

- **Engine** — foundational AOS system (**`nirmata.Aos`**)
- **Plane** — agent plane responsible for workflows, subagents, orchestration (**`nirmata.Agents`** + hosts)
- **Product** — UI + product API + product services + product database + DTOs (**`nirmata.Web`, `nirmata.Api`, `nirmata.Services`, `nirmata.Data`, `nirmata.Data.Dto`**)
...
- API: `nirmata.Api`
- Services: `nirmata.Services`
- Data access: `nirmata.Data`
- DTOs: `nirmata.Data.Dto`
- Web UI: `nirmata.Web`
- Shared cross-cutting library: `nirmata.Common`
...
- Windows Service host: `nirmata.Windows.Service`
- Plane host API: `nirmata.Windows.Service.Api`
...
- `nirmata.Aos` (Engine)
- `nirmata.Agents` (Plane)
- `nirmata.Api` (Product API)
- `nirmata.Services` (Product services/business logic)
- `nirmata.Data` (Product persistence/data access)
- `nirmata.Data.Dto` (DTO contracts)
- `nirmata.Web` (Product UI)
- `nirmata.Common` (Shared utilities/types used across Product; avoid leaking orchestration here)
- `nirmata.Windows.Service` (Plane host/runtime)
- `nirmata.Windows.Service.Api` (Plane host API surface)
...
# 1) ENGINE ROADMAP (nirmata.Aos)

> Goal: make `nirmata.Aos` a programmable spec/state engine with deterministic artifacts + validation + contracts that Plane workflows can rely on.
...
- [x] **PH-ENG-0001 — Public API shape + “compile-against” contract**  
  **Outcome:** `nirmata.Aos/Public/**` becomes the only stable surface other projects compile against; internal engine remains swappable.
  - **Projects:** `nirmata.Aos`
  - **Code paths (target):**
    - `nirmata.Aos/Public/**`
    - `nirmata.Aos/Public/Services/**`
    - `nirmata.Aos/Public/Catalogs/**`
    - `nirmata.Aos/Contracts/**`
    - `nirmata.Aos/Engine/**` (internal-only implementation)
    - `nirmata.Aos/_Shared/**` (internal-only implementation)
  - **Workspace outputs (target):** *(none — API boundary and internals only)*
  - **Example artifacts:** *(n/a)*
  - **Verify:** `dotnet build nirmata.Aos.csproj`
  - Define Engine Public surface skeleton  
    - **Scope:** `nirmata.Aos/Public/**`, `nirmata.Aos/Public/Services/**`, `nirmata.Aos/Public/Catalogs/**`, `nirmata.Aos/Contracts/**`  
  ...
  - Introduce internal “Engine Core” namespaces  
    - **Scope:** `nirmata.Aos/Engine/**`, `nirmata.Aos/_Shared/**`  
  ...
  - Enforce “no direct internal reference” rule  
    - **Scope:** `nirmata.Aos.csproj`, `nirmata.Aos/Public/**`  
...
- [x] **PH-ENG-0002 — Workspace root + canonical path mapping**  
  **Outcome:** Engine opens repo-root workspace, finds/creates `.aos/`, maps IDs → canonical files predictably.
  - **Projects:** `nirmata.Aos`
  - **Code paths (target):**
    - `nirmata.Aos/Workspace/**`
    - `nirmata.Aos/Paths/**`
    - `nirmata.Aos/Paths/Artifacts/**`
    - `nirmata.Aos/Serialization/**`
  ...
  - Workspace discovery + `.aos` root contract  
    - **Scope:** `nirmata.Aos/Workspace/**`, `nirmata.Aos/Paths/**`  
  ...
  - Artifact path resolver (IDs → paths)  
    - **Scope:** `nirmata.Aos/Paths/Artifacts/**`  
  ...
  - Deterministic JSON read/write policy  
    - **Scope:** `nirmata.Aos/Serialization/**`  
...
- [x] **PH-ENG-0003 — Schema registry + schema validator**  
  **Outcome:** engine loads embedded schemas by ID and validates artifacts structurally + cross-file invariants.
  - **Projects:** `nirmata.Aos`
  - **Code paths (target):**
    - `nirmata.Aos/Resources/Schemas/**` (embedded `*.schema.json`)
    - `nirmata.Aos/Validation/Schemas/**` (schema registry/loader)
    - `nirmata.Aos/Validation/**` (structural + invariant validation)
    - `nirmata.Aos/Spec/Indexes/**` (invariant support / reference resolution)
  - **Workspace outputs (target):** *(none — validation operates over `.aos/**` artifacts but schemas are embedded in the assembly)*
  - **Example artifacts:**
    - `nirmata.Aos/Resources/Schemas/project.schema.json`
    - `nirmata.Aos/Resources/Schemas/workspace-lock.schema.json`
  ...
  - Embed schema assets + schema loader  
    - **Scope:** `nirmata.Aos/Validation/Schemas/**`, `nirmata.Aos/Resources/Schemas/**`  
...
- [x] **PH-ENG-0004 — Intended truth (spec) CRUD + indexing**  
  **Outcome:** deterministic read/write APIs for spec artifacts under `.aos/spec/**`.
  ...
  - SpecStore CRUD (project/roadmap/milestone/phase/task/issue/uat)  
    - **Scope:** `nirmata.Aos/Spec/**`, `nirmata.Aos/Spec/Indexes/**`  
  ...
  - Index repair utility  
    - **Scope:** `nirmata.Aos/Spec/Indexes/**`  
...
- [x] **PH-ENG-0005 — Operational truth (state + events)**  
  **Outcome:** `.aos/state/state.json` + `.aos/state/events.ndjson` managed via StateStore.
  ...
  - **Code paths (target):**
    - `nirmata.Aos/State/**`
    - `nirmata.Aos/Models/State/**`
    - `nirmata.Aos/State/Events/**`
  - **Workspace outputs (target):**
    ```text
    .aos/
      state/
  ...
  - StateStore + cursor model  
    - **Scope:** `nirmata.Aos/State/**`, `nirmata.Aos/Models/State/**`  
  ...
  - Event append + tail reader  
    - **Scope:** `nirmata.Aos/State/Events/**`  
...
- [x] **PH-ENG-0006 — Provable truth (evidence)**  
  **Outcome:** Engine creates RUN folders, attaches logs/artifacts, maintains task-evidence pointers.
  - **Projects:** `nirmata.Aos`
  - **Code paths (target):**
    - `nirmata.Aos/Evidence/**`
    - `nirmata.Aos/Evidence/TaskEvidence/**`
    - `nirmata.Aos/Paths/Artifacts/**`
  - **Workspace outputs (target):**
    ```text
    .aos/
  ...
  - Run lifecycle storage  
    - **Scope:** `nirmata.Aos/Evidence/**`, `nirmata.Aos/Paths/Artifacts/**`  
  ...
  - Task-evidence latest pointer  
    - **Scope:** `nirmata.Aos/Evidence/TaskEvidence/**`  
...
- [x] **PH-ENG-0007 — Context pack builder**  
  **Outcome:** deterministic, budgeted context packs under `.aos/context/packs/**` (task/phase modes).
  ...
  - **Code paths (target):**
    - `nirmata.Aos/Context/**`
    - `nirmata.Aos/Context/Packs/**`
    - `nirmata.Aos/Validation/Schemas/**` (context pack schema integration)
  - **Workspace outputs (target):**
    ```text
    .aos/
      context/
...
- [x] **PH-ENG-0009 — Tool contracts + registry**  
  **Outcome:** Engine defines tool invocation contract, descriptors, and registry (including MCP boundary).
  - **Projects:** `nirmata.Aos`
  - **Code paths (target):**
    - `nirmata.Aos/Contracts/Tools/**`
    - `nirmata.Aos/Tools/**`
    - `nirmata.Aos/Registry/**`
    - `nirmata.Aos/Public/Catalogs/**`
    - `nirmata.Aos/Mcp/**`
  - **Workspace outputs (target):** *(none — tools are invoked by Plane; evidence capture is handled via the EvidenceStore phase)*  
  - **Example artifacts:**
    - `nirmata.Aos/Contracts/Tools/` *(request/result shapes)*
    - `nirmata.Aos/Public/Catalogs/` *(stable tool IDs / enumeration surface)*
  ...
  - Tool contract + descriptor models  
    - **Scope:** `nirmata.Aos/Contracts/Tools/**`, `nirmata.Aos/Tools/**`  
    - **Outputs:** `ITool`, request/result shapes, metadata model  
    - **Verify:** registry register + resolve by ID/name
  - Tool registry + catalog  
    - **Scope:** `nirmata.Aos/Registry/**`, `nirmata.Aos/Public/Catalogs/**`  
    - **Outputs:** stable tool catalog; deterministic enumeration  
    - **Verify:** list order stable
  - MCP adapter boundary  
    - **Scope:** `nirmata.Aos/Mcp/**`  
    - **Outputs:** MCP endpoint wrapped as `ITool`  
    - **Verify:** stub invoke returns normalized result

- [x] **PH-ENG-0010 — Semantic Kernel integration for LLM orchestration (in nirmata.Agents)**  
  **Outcome:** provider-agnostic LLM interface + adapters + prompt assets outside code.
  - **Projects:** `nirmata.Agents`
  - **Code paths (target):**
    - `nirmata.Agents/Configuration/SemanticKernelOptions.cs`
    - `nirmata.Agents/Configuration/SemanticKernelServiceCollectionExtensions.cs`
    - `nirmata.Agents/Execution/ControlPlane/Llm/Filters/AosEvidenceFunctionFilter.cs`
    - `nirmata.Agents/Execution/ControlPlane/Llm/Tools/ToolToKernelFunctionAdapter.cs`
    - `nirmata.Agents/Execution/ControlPlane/Llm/Tools/KernelPluginFactory.cs`
    - `nirmata.Agents/Execution/ControlPlane/Llm/Prompts/SemanticKernelPromptFactory.cs`
    - `nirmata.Agents/Resources/Prompts/**`
  ...
  - **Example artifacts:**
    - `nirmata.Agents/Configuration/SemanticKernelOptions.cs` *(SK configuration options for all providers)*
    - `nirmata.Agents/Resources/Prompts/*.prompt.yaml` *(SK-compatible prompt templates)*
  ...
  - Semantic Kernel configuration and DI registration
    - **Scope:** `nirmata.Agents/Configuration/SemanticKernelOptions.cs`, `nirmata.Agents/Configuration/SemanticKernelServiceCollectionExtensions.cs`
  ...
  - Provider connectors (OpenAI, Azure OpenAI, Ollama, Anthropic)
    - **Scope:** `nirmata.Agents/Configuration/SemanticKernelServiceCollectionExtensions.cs` (provider-specific builder methods)
  ...
  - Evidence capture via SK function filter
    - **Scope:** `nirmata.Agents/Execution/ControlPlane/Llm/Filters/AosEvidenceFunctionFilter.cs`
  ...
  - Tool system integration with SK
    - **Scope:** `nirmata.Agents/Execution/ControlPlane/Llm/Tools/ToolToKernelFunctionAdapter.cs`, `nirmata.Agents/Execution/ControlPlane/Llm/Tools/KernelPluginFactory.cs`
  ...
  - Prompt template loading for SK
    - **Scope:** `nirmata.Agents/Execution/ControlPlane/Llm/Prompts/SemanticKernelPromptFactory.cs`, `nirmata.Agents/Resources/Prompts/**`
...
- [x] **PH-ENG-0011 — Command router + command group handlers**  
  **Outcome:** Engine exposes handlers matching the AOS command catalog (even if CLI host is elsewhere).
  - **Projects:** `nirmata.Aos`
  - **Code paths (target):**
    - `nirmata.Aos/Public/Services/**` (command routing surface)
    - `nirmata.Aos/Public/Catalogs/**` (command IDs/catalog)
    - `nirmata.Aos/Engine/Commands/**` (command implementations)
    - `nirmata.Aos/Engine/Commands/{Base,Validate,Spec,State,Runs}/**`
    - `nirmata.Aos/Engine/Commands/Help/**`
  ...
  - CommandRouter + CommandCatalog  
    - **Scope:** `nirmata.Aos/Public/Services/**`, `nirmata.Aos/Public/Catalogs/**`, `nirmata.Aos/Engine/Commands/**`  
  ...
  - Implement core handler set (init/status/config/validate/spec/state/run)  
    - **Scope:** `nirmata.Aos/Engine/Commands/{Base,Validate,Spec,State,Runs}/**`  
  ...
  - Help renderer uses command catalog  
    - **Scope:** `nirmata.Aos/Engine/Commands/Help/**`  
    - **Outputs:** help output generated from registered commands  
    - **Verify:** help includes spec/state/run/etc.

- [x] **PH-ENG-0012 — DI registration extension (`AddnirmataAos`)**  
  **Outcome:** Engine services registerable via `IServiceCollection` extension for direct consumption by Plane.
  - **Projects:** `nirmata.Aos`
  - **Code paths (target):**
    - `nirmata.Aos/Composition/ServiceCollectionExtensions.cs`
    - `nirmata.Aos/Public/Services/**` (interface registrations)
  - **Workspace outputs (target):** *(none — composition only)*
  - **Example artifacts:**
    - `nirmata.Aos/Composition/ServiceCollectionExtensions.cs` with `AddnirmataAos(this IServiceCollection)`
  - **Verify:** `nirmata.Agents` can call `services.AddnirmataAos()` and resolve `ICommandRouter`, `IWorkspace`, `ISpecStore`, `IStateStore`, `IEvidenceStore`, `IValidator`
  - AddnirmataAos extension method  
    - **Scope:** `nirmata.Aos/Composition/ServiceCollectionExtensions.cs`  
    ...
    - **Verify:** `nirmata.Agents` composition can resolve Engine services
  - Service lifetime conventions  
    - **Scope:** `nirmata.Aos/Composition/**`  
  ...
  - Configuration binding  
    - **Scope:** `nirmata.Aos/Configuration/**`  
    - **Outputs:** `IOptions<AosOptions>` for engine configuration  
    - **Verify:** config flows from `nirmata.Agents` appsettings to Engine
...
- [x] **PH-ENG-0013 — AOS E2E verification + agent integration tests**  
  **Outcome:** a dedicated verification phase that proves `aos init` + the full control-loop (spec → roadmap → plan → execute → verify → fix) works end-to-end, using real filesystem artifacts under `.aos/` and run evidence.
  ...
  - **Code paths (target):**
    - `tests/nirmata.Aos.Tests/E2E/**`
    - `tests/nirmata.Agents.Tests/E2E/**`
...
# 2) PLANE ROADMAP (nirmata.Agents + Hosts)
...
- [x] **PH-PLN-0001 — `nirmata.Agents` DI + configuration baseline**  
  **Outcome:** hosts wire up workflows consistently via one composition root; consumes Engine services directly (not via CLI).
  - **Projects:** `nirmata.Agents`
  - **Code paths (target):**
    - `nirmata.Agents/Composition/**`
    - `nirmata.Agents/Configuration/**`
    - `nirmata.Agents/Models/**`
    - `nirmata.Agents/Persistence/**`
    - `nirmata.Agents/Observability/**`
    - `nirmata.Agents/Program.cs`
    - `nirmata.Agents/appsettings.json`
  - **Workspace outputs (target):** *(none — composition/runtime scaffolding only; actual `.aos/**` writes happen when workflows execute)*
  - **Example artifacts:** *(n/a)*
  - **Verify:** `dotnet build nirmata.Agents.csproj`; log correlation ID format includes `RUN-*` when executing a run
  - AddnirmataAgents composition root  
    - **Scope:** `nirmata.Agents/Composition/**`, `nirmata.Agents/Configuration/**`, `nirmata.Agents/Program.cs`, `nirmata.Agents/appsettings.json`  
    - **Outputs:** calls `AddnirmataAos()` to register Engine services, then registers Plane workflows  
    - **Verify:** `dotnet build nirmata.Agents.csproj`
  - Runtime models + persistence abstractions  
    - **Scope:** `nirmata.Agents/Models/**`, `nirmata.Agents/Persistence/**`  
    - **Outputs:** run request/response models; wrappers over Engine stores  
    - **Verify:** compile + minimal smoke
  - Observability scaffolding  
    - **Scope:** `nirmata.Agents/Observability/**`  
...
- [x] **PH-PLN-0002 — Orchestrator workflow implements gating + dispatch**  
  **Outcome:** “classify → gate → dispatch → validate → persist → next” orchestrator exists as a workflow calling Engine stores/validator **via injected services** (direct method calls, not CLI).
  - **Projects:** `nirmata.Agents`
  - **Code paths (target):**
    - `nirmata.Agents/Execution/Orchestrator/**`
    - `nirmata.Agents/Persistence/**` (run lifecycle wrappers over Engine stores)
  - **Workspace outputs (target):**
    ```text
    .aos/
      evidence/
  ...
  - Input classification + command normalization  
    - **Scope:** `nirmata.Agents/Execution/Orchestrator/**`  
  ...
  - Run record lifecycle integration  
    - **Scope:** `nirmata.Agents/Persistence/**`, `nirmata.Agents/Execution/Orchestrator/**`  
...
- [x] **PH-PLN-0003 — New-Project Interviewer workflow**  
  **Outcome:** writes `.aos/spec/project.json` as canonical project truth.
  - **Projects:** `nirmata.Agents`
  - **Code paths (target):**
    - `nirmata.Agents/Execution/Planning/NewProjectInterviewer/**`
  - **Workspace outputs (target):**
    ```text
    .aos/
      spec/
  ...
  - Implement Interviewer workflow  
    - **Scope:** `nirmata.Agents/Execution/Planning/NewProjectInterviewer/**`  
...
- [x] **PH-PLN-0004 — Roadmapper workflow**  
  **Outcome:** writes `.aos/spec/roadmap.json` + initializes `.aos/state/*`.
  - **Projects:** `nirmata.Agents`
  - **Code paths (target):**
    - `nirmata.Agents/Execution/Planning/Roadmapper/**`
  - **Workspace outputs (target):**
    ```text
    .aos/
      spec/
  ...
  - Implement Roadmapper workflow  
    - **Scope:** `nirmata.Agents/Execution/Planning/Roadmapper/**`  
...
- [x] **PH-PLN-0005 — Phase Context Gatherer + Phase Planner workflows**  
  **Outcome:** decomposes phase into 2–3 atomic tasks with plan.json scopes and verification steps.
  - **Projects:** `nirmata.Agents`
  - **Code paths (target):**
    - `nirmata.Agents/Execution/Planning/PhasePlanner/**`
    - `nirmata.Agents/Execution/Planning/PhasePlanner/ContextGatherer/**`
    - `nirmata.Agents/Execution/Planning/PhasePlanner/Assumptions/**`
  - **Workspace outputs (target):**
    ```text
    .aos/
      spec/
  ...
  - Phase Context Gatherer  
    - **Scope:** `nirmata.Agents/Execution/Planning/PhasePlanner/ContextGatherer/**`  
    - **Outputs:** phase brief persisted as decisions/events  
    - **Verify:** decisions appear in state
  - Phase Planner  
    - **Scope:** `nirmata.Agents/Execution/Planning/PhasePlanner/**`  
  ...
  - Phase Assumption Lister  
    - **Scope:** `nirmata.Agents/Execution/Planning/PhasePlanner/Assumptions/**`  
...
- [x] **PH-PLN-0006 — Roadmap Modifier / Phase Remover workflows**  
  **Outcome:** insert/remove phases safely, renumber consistently, keep cursor coherent.
  - **Projects:** `nirmata.Agents`
  - **Code paths (target):**
    - `nirmata.Agents/Execution/Planning/RoadmapModifier/**`
  - **Workspace outputs (target):**
    ```text
    .aos/
      spec/
  ...
  - Roadmap Modifier  
    - **Scope:** `nirmata.Agents/Execution/Planning/RoadmapModifier/**`  
...
- [x] **PH-PLN-0007 — Task Executor workflow**  
  **Outcome:** executes tasks sequentially, strict scope, fresh subagent per task, evidence capture.
  - **Projects:** `nirmata.Agents`
  - **Code paths (target):**
    - `nirmata.Agents/Execution/Execution/TaskExecutor/**`
    - `nirmata.Agents/Execution/Execution/SubagentRuns/**`
  - **Workspace outputs (target):**
    ```text
    .aos/
      evidence/
  ...
  - Task Executor  
    - **Scope:** `nirmata.Agents/Execution/Execution/TaskExecutor/**`  
  ...
  - Subagent orchestration wrapper  
    - **Scope:** `nirmata.Agents/Execution/Execution/SubagentRuns/**`  
...
- [x] **PH-PLN-0008 — Atomic Git Committer workflow**  
  **Outcome:** stages only task-scoped files and commits with TSK-based messages.
  - **Projects:** `nirmata.Agents`
  - **Code paths (target):**
    - `nirmata.Agents/Execution/Execution/AtomicGitCommitter/**`
  - **Workspace outputs (target):**
    ```text
    .aos/
      evidence/
  ...
  - Git commit workflow  
    - **Scope:** `nirmata.Agents/Execution/Execution/AtomicGitCommitter/**`  
...
- [x] **PH-PLN-0009 — UAT Verifier workflow**  
  **Outcome:** verify-work runs acceptance checks, writes issues, records pass/fail with evidence.
  - **Projects:** `nirmata.Agents`
  - **Code paths (target):**
    - `nirmata.Agents/Execution/Verification/UatVerifier/**`
  - **Workspace outputs (target):**
    ```text
    .aos/
      spec/
  ...
  - UAT checklist derived from acceptance criteria  
    - **Scope:** `nirmata.Agents/Execution/Verification/UatVerifier/**`  
...
- [x] **PH-PLN-0010 — Fix Planner workflow**  
  **Outcome:** consumes UAT failures and generates 2–3 task fix plans with verification steps.
  - **Projects:** `nirmata.Agents`
  - **Code paths (target):**
    - `nirmata.Agents/Execution/FixPlanner/**`
  - **Workspace outputs (target):**
    ```text
    .aos/
      spec/
  ...
  - Fix plan generator  
    - **Scope:** `nirmata.Agents/Execution/FixPlanner/**`  
...
- [x] **PH-PLN-0011 — Pause/Resume Manager workflow**  
  **Outcome:** interruption-safe handoff snapshot and deterministic resume.
  - **Projects:** `nirmata.Agents`
  - **Code paths (target):**
    - `nirmata.Agents/Execution/Continuity/PauseResumeManager/**`
  - **Workspace outputs (target):**
    ```text
    .aos/
      state/
  ...
  - pause-work / resume-work  
    - **Scope:** `nirmata.Agents/Execution/Continuity/PauseResumeManager/**`, `.aos/state/handoff.json`  
...
- [x] **PH-PLN-0012 — Progress Reporter + History Writer workflows**  
  **Outcome:** deterministic progress report + durable narrative summary with evidence references.
  - **Projects:** `nirmata.Agents`
  - **Code paths (target):**
    - `nirmata.Agents/Execution/Continuity/ProgressReporter/**`
    - `nirmata.Agents/Execution/Continuity/HistoryWriter/**`
  - **Workspace outputs (target):**
    ```text
    .aos/
      spec/
  ...
  - Progress Reporter  
    - **Scope:** `nirmata.Agents/Execution/Continuity/ProgressReporter/**`  
    - **Outputs:** current cursor, blockers, next recommended command  
    - **Verify:** matches state/roadmap/tasks deterministically
  - History Writer  
    - **Scope:** `nirmata.Agents/Execution/Continuity/HistoryWriter/**`, `.aos/spec/summary.md` (or `.aos/evidence/summary.md`)  
...
- [x] **PH-PLN-0013 — Deferred Issues Curator + Todo capture/review**  
  **Outcome:** deferred queue separate from roadmap; triage routes urgent items into main loop.
  - **Projects:** `nirmata.Agents`
  - **Code paths (target):**
    - `nirmata.Agents/Execution/Backlog/DeferredIssuesCurator/**`
    - `nirmata.Agents/Execution/Backlog/TodoCapturer/**`
    - `nirmata.Agents/Execution/Backlog/TodoReviewer/**`
  - **Workspace outputs (target):**
    ```text
    .aos/
      context/
...
- [x] **PH-PLN-0014 — Codebase Mapper workflow**  
  **Outcome:** `.aos/codebase/**` intelligence pack + caches (symbols + file-graph).
  - **Projects:** `nirmata.Agents`
  - **Code paths (target):**
    - `nirmata.Agents/Execution/Brownfield/CodebaseMapper/**`
  - **Workspace outputs (target):**
    ```text
    .aos/
      codebase/
  ...
  - codebase scan + map build equivalents  
    - **Scope:** `nirmata.Agents/Execution/Brownfield/CodebaseMapper/**`, `.aos/codebase/**`  
...
## MS-PRD-0001 — Product Data Baseline (`nirmata.Data`)
...
- [x] **PH-PRD-0001 — EF Core context + entities + migrations skeleton**  
  **Outcome:** product DB exists with clean separation from `.aos/` artifacts.
  - **Projects:** `nirmata.Data`
  - **Code paths (target):**
    - `nirmata.Data/Context/**`
    - `nirmata.Data/Entities/**`
...
- [x] **PH-PRD-0002 — DTO models + request validators**  
  **Outcome:** API boundary DTOs exist with validation.
  ...
  - DTO models + request shapes  
    - **Scope:** `nirmata.Data.Dto/Models/**`, `nirmata.Data.Dto/Requests/**`  
    - **Outputs:** DTOs for core entities  
    - **Verify:** compile passes
  - Validators  
    - **Scope:** `nirmata.Data.Dto/Validators/**`  
    - **Outputs:** validation rules aligned with API constraints  
    - **Verify:** invalid DTO fails as expected

---

## MS-PRD-0003 — Product Services Tier (`nirmata.Services`)

- [x] **PH-PRD-0003 — Services interfaces + implementations**  
  **Outcome:** application logic lives in `nirmata.Services`, not controllers or UI.
  - **Projects:** `nirmata.Services` (and mapping in `nirmata.Data`)
  - **Code paths (target):**
    - `nirmata.Services/Interfaces/**`
    - `nirmata.Services/Implementations/**`
    - `nirmata.Services/Composition/**`
    - `nirmata.Data/Mapping/**` (DTO/entity mapping boundary)
  - **Workspace outputs (target):** *(none — compiled services consumed by `nirmata.Api` and optionally `nirmata.Web`)*
  - **Example artifacts:**
    - `nirmata.Services/Composition/` *(e.g., `AddnirmataServices(...)`)*
    - `nirmata.Services/Interfaces/` *(use-case contracts)*
  - **Verify:** `nirmata.Api` resolves services via DI; service-level tests pass
  - Service interfaces  
    - **Scope:** `nirmata.Services/Interfaces/**`  
    - **Outputs:** use-case interfaces  
    - **Verify:** build; no circular refs
  - Service implementations + mapping  
    - **Scope:** `nirmata.Services/Implementations/**`, `nirmata.Data/Mapping/**`  
    - **Outputs:** impls using Data; map to DTOs  
    - **Verify:** service-level tests pass
  - Services composition root  
    - **Scope:** `nirmata.Services/Composition/**`  
    - **Outputs:** `AddnirmataServices(...)`  
    - **Verify:** `nirmata.Api` resolves services

---

## MS-PRD-0004 — Product REST API (`nirmata.Api`)

- [x] **PH-PRD-0004 — Versioned controllers + health**  
  **Outcome:** stable product API with clean controller/service split.
  - **Projects:** `nirmata.Api`
  - **Code paths (target):**
    - `nirmata.Api/Program.cs`
    - `nirmata.Api/appsettings*.json`
    - `nirmata.Api/Controllers/V1/**` *(preferred versioned controller location)*
    - `nirmata.Api/Controllers/**` *(health/base controllers as needed)*
  - **Workspace outputs (target):** *(none — runtime is HTTP service; persistence lives in `nirmata.Data`)*
  - **Example artifacts:**
    - `nirmata.Api/Controllers/V1/ProjectController.cs` *(example v1 controller)*
    - `nirmata.Api/Program.cs`
  - **Verify:** local run; swagger loads; integration tests hit v1 endpoints and health endpoints
  - API skeleton + DI wiring  
    - **Scope:** `nirmata.Api/Program.cs`, `nirmata.Api/appsettings*.json`  
    - **Outputs:** controllers, services/data DI, swagger  
    - **Verify:** local run; swagger loads
  - Core controllers (v1)  
    - **Scope:** `nirmata.Api/Controllers/V1/**`, `nirmata.Api/HealthController.cs`, `nirmata.Api/nirmataController.cs`  
    - **Outputs:** baseline endpoints + health  
    - **Verify:** integration tests hit endpoints

---

## MS-PRD-0005 — Web UI (`nirmata.Web`)

- [x] **PH-PRD-0005 — Razor Pages shell + assets + basic product views**  
  **Outcome:** UI shell shows product data and later agent run status.
  - **Projects:** `nirmata.Web`
  - **Code paths (target):**
    - `nirmata.Web/Pages/**`
    - `nirmata.Web/Shared/Views/**`
    - `nirmata.Web/wwwroot/**`
    - `nirmata.Web/assets/**`
  - **Workspace outputs (target):** *(static assets and compiled web app; no `.aos/**` ownership)*
  - **Example artifacts:**
    - `nirmata.Web/Pages/Index.cshtml` *(example)*
    - `nirmata.Web/wwwroot/` *(static assets root)*
  - **Verify:** homepage renders; read-only list/detail pages render product data via services or API client
  - Layout + static assets  
    - **Scope:** `nirmata.Web/Pages/**`, `nirmata.Web/Shared/Views/**`, `nirmata.Web/wwwroot/**`, `nirmata.Web/assets/**`  
    - **Outputs:** base layout/nav, css/js pipeline, error pages  
    - **Verify:** homepage renders
  - Product data pages (read-only first)  
    - **Scope:** `nirmata.Web/Pages/**`  
...
- [x] **PH-PRD-0006 — Direct agent runner for MVP (no Windows Service)**  
  **Outcome:** Product can invoke agents directly via `nirmata.Agents` library for MVP/debugging.
  - **Projects:** `nirmata.Web`, `nirmata.Agents`
  - **Code paths (target):**
    - `nirmata.Web/AgentRunner/**`
    - `nirmata.Web/Composition/**`
  ...
  - **Example artifacts:**
    - `nirmata.Web/AgentRunner/WorkflowClassifier.cs`
    - `nirmata.Web/Pages/Runs/Index.cshtml` *(runs dashboard)*
  - **Verify:** UI can start a run directly; runs dashboard displays run status/evidence
  - Direct agent runner (in-process)  
    - **Scope:** `nirmata.Web/AgentRunner/**`  
    - **Outputs:** wrapper that calls `nirmata.Agents` orchestrator directly (no HTTP/service boundary)  
  ...
  - DI wiring for direct mode  
    - **Scope:** `nirmata.Web/Composition/**`  
    - **Outputs:** `AddnirmataAgents()` called directly in Web DI  
...
- [x] **PH-PRD-0007 — Initial data seeds + migration tooling**  
  **Outcome:** clean baseline data for product entities.
  - **Projects:** `nirmata.Data`
  - **Code paths (target):**
    - `nirmata.Data/Migrations/Seeds/**`
  - **Workspace outputs (target):** *(none — database seeds)*
  - **Example artifacts:**
    - `nirmata.Data/Migrations/Seeds/InitialData.sql`
...
- [x] **PH-PRD-0008 — Core UI Pages (Spec → Plan → Execute → Verify → Fix)**
  **Outcome:** minimum UI surface to make the AOS engine operational end-to-end.
  - **Projects:** `nirmata.Web`
  - **Code paths (target):**
    - `nirmata.Web/Pages/Workspace/**`
    - `nirmata.Web/Pages/Dashboard/**`
    - `nirmata.Web/Pages/Command/**`
    - `nirmata.Web/Pages/Specs/**`
...
- [x] **PH-PRD-0009 — Execution & Verification UI Pages**
  **Outcome:** execution tracking, verification, and issue management UI.
  - **Projects:** `nirmata.Web`
  - **Code paths (target):**
    - `nirmata.Web/Pages/Roadmap/**`
    - `nirmata.Web/Pages/Milestones/**`
    - `nirmata.Web/Pages/Phases/**`
    - `nirmata.Web/Pages/Tasks/**`
    - `nirmata.Web/Pages/Runs/**`
    - `nirmata.Web/Pages/Uat/**`
    - `nirmata.Web/Pages/Issues/**`
  - **Workspace outputs (target):** *(none — UI only)*
...
- [x] **PH-PRD-0010 — Advanced UI Pages (Fix Planning, Intelligence, State)**
  **Outcome:** fix planning, codebase intelligence, context packs, and state management UI.
  - **Projects:** `nirmata.Web`
  - **Code paths (target):**
    - `nirmata.Web/Pages/Fix/**`
    - `nirmata.Web/Pages/Codebase/**`
    - `nirmata.Web/Pages/Context/**`
    - `nirmata.Web/Pages/State/**`
    - `nirmata.Web/Pages/Validation/**`
  - **Workspace outputs (target):** *(none — UI only)*
...
- [x] **PH-PRD-0012 — Workspace Management API**
  **Outcome:** backend services for workspace picker and configuration.
  - **Projects:** `nirmata.Web`
  - **Code paths (target):**
    - `nirmata.Web/Services/WorkspaceService.cs`
    - `nirmata.Web/Models/WorkspaceModels.cs`
    - `nirmata.Web/Controllers/WorkspaceController.cs`
  - **Workspace outputs (target):**
...
- [ ] **PH-PRD-0013 — Dashboard & State API**
  **Outcome:** backend services for dashboard overview and cursor tracking.
  - **Projects:** `nirmata.Web`
  - **Code paths (target):**
    - `nirmata.Web/Services/DashboardService.cs`
    - `nirmata.Web/Services/StateService.cs`
    - `nirmata.Web/Controllers/DashboardController.cs`
...
- [ ] **PH-PRD-0014 — Command Center API (Chat + Runs)**
  **Outcome:** backend services for chat UI and command execution.
  - **Projects:** `nirmata.Web`
  - **Code paths (target):**
    - `nirmata.Web/Services/CommandService.cs`
    - `nirmata.Web/Services/ChatService.cs`
    - `nirmata.Web/Controllers/CommandController.cs`
    - `nirmata.Web/Hubs/CommandHub.cs` *(SignalR for streaming)*
  - **Workspace outputs (target):**
  ...
  - Command execution wrapper: invoke nirmata.Agents orchestrator, capture output
...
- [ ] **PH-PRD-0015 — Spec Management API**
  **Outcome:** backend services for spec CRUD, validation, and diff.
  - **Projects:** `nirmata.Web`
  - **Code paths (target):**
    - `nirmata.Web/Services/SpecService.cs`
    - `nirmata.Web/Services/ValidationService.cs`
    - `nirmata.Web/Controllers/SpecsController.cs`
  - **Workspace outputs (target):**
    - `.aos/spec/**` (read/write)
...
- [ ] **PH-PRD-0016 — Roadmap, Milestones, Phases API**
  **Outcome:** backend services for roadmap structure and phase planning.
  - **Projects:** `nirmata.Web`
  - **Code paths (target):**
    - `nirmata.Web/Services/RoadmapService.cs`
    - `nirmata.Web/Services/MilestoneService.cs`
    - `nirmata.Web/Services/PhaseService.cs`
    - `nirmata.Web/Controllers/RoadmapController.cs`
  - **Workspace outputs (target):**
    - `.aos/spec/roadmap.json`
...
- [ ] **PH-PRD-0017 — Tasks, Runs, UAT, Issues API**
  **Outcome:** backend services for task execution and verification workflow.
  - **Projects:** `nirmata.Web`
  - **Code paths (target):**
    - `nirmata.Web/Services/TaskService.cs`
    - `nirmata.Web/Services/RunService.cs`
    - `nirmata.Web/Services/UatService.cs`
    - `nirmata.Web/Services/IssueService.cs`
    - `nirmata.Web/Controllers/TasksController.cs`, `RunsController.cs`, `UatController.cs`, `IssuesController.cs`
  - **Workspace outputs (target):**
    - `.aos/spec/tasks/**/*.json`
    - `.aos/evidence/runs/RUN-*/**`
    - `.aos/spec/uat/*.json`
...
- [ ] **PH-PRD-0018 — Fix Planning, Intelligence, State Management API**
  **Outcome:** backend services for repair loop, codebase intelligence, and state control.
  - **Projects:** `nirmata.Web`
  - **Code paths (target):**
    - `nirmata.Web/Services/FixPlanningService.cs`
    - `nirmata.Web/Services/CodebaseService.cs`
    - `nirmata.Web/Services/ContextPackService.cs`
    - `nirmata.Web/Services/CheckpointService.cs`
    - `nirmata.Web/Services/PauseResumeService.cs`
  - **Workspace outputs (target):**
...
- [ ] **PH-PRD-0019 — Validation & Maintenance API**
  **Outcome:** backend services for system validation and maintenance.
  - **Projects:** `nirmata.Web`
  - **Code paths (target):**
    - `nirmata.Web/Services/SystemValidationService.cs`
    - `nirmata.Web/Services/MaintenanceService.cs`
    - `nirmata.Web/Controllers/ValidationController.cs`
  - **Workspace outputs (target):**
...
> Goal: provide a Windows Service host for production deployments. Skip this for MVP/debugging — use direct invocation in `nirmata.Web` instead.

---

## MS-HST-0001 — Windows Service Host

- [ ] **PH-HST-0001 — Windows Service Host (`nirmata.Windows.Service`)**  
  **Outcome:** daemon that runs agent runtime with shared configuration and filesystem access.
  - **Projects:** `nirmata.Windows.Service`
  - **Code paths (target):**
    - `nirmata.Windows.Service/Program.cs`
    - `nirmata.Windows.Service/appsettings*.json`
    - `nirmata.Agents/Workers/**`
    - `nirmata.Windows.Service/**` (service hosting + lifecycle)
  ...
  - Host wiring + DI  
    - **Scope:** `nirmata.Windows.Service/Program.cs`, `nirmata.Windows.Service/appsettings*.json`  
    - **Outputs:** loads `AddnirmataAgents(...)`, binds config, logging  
    - **Verify:** service starts (console run ok)
  - Background worker execution model  
    - **Scope:** `nirmata.Agents/Workers/**`, `nirmata.Windows.Service/**`  
    - **Outputs:** worker accepts run requests and executes orchestrator  
    - **Verify:** executes no-op command in test workspace

- [ ] **PH-HST-0002 — Windows Service API (`nirmata.Windows.Service.Api`)**  
  **Outcome:** stable API surface to start/monitor/control runs (no engine leakage).
  - **Projects:** `nirmata.Windows.Service.Api`
  - **Code paths (target):**
    - `nirmata.Windows.Service.Api/v1/Controllers/**`
    - `nirmata.Windows.Service.Api/**` (API composition, hosting, auth, clients)
    - `nirmata.Agents/Execution/Orchestrator/**` (invoked by the API)
  - **Workspace outputs (target):**
    ```text
    .aos/
      evidence/
  ...
  - Controllers (Commands/Runs/Service/Health)  
    - **Scope:** `nirmata.Windows.Service.Api/v1/Controllers/**`  
  ...
  - API ↔ Orchestrator integration  
    - **Scope:** `nirmata.Windows.Service.Api/**`, `nirmata.Agents/Execution/Orchestrator/**`  
...
- [ ] **PH-HST-0003 — UI can start runs via Service API**  
  **Outcome:** product integrates with Windows Service for production deployments.
  - **Projects:** `nirmata.Web`, `nirmata.Windows.Service.Api`
  - **Code paths (target):**
    - `nirmata.Web/Clients/**` *(typed client wrapper around Service Manager API)*
    - `nirmata.Web/Configuration/**` *(service vs direct mode toggle)*
    - `nirmata.Windows.Service.Api/**` *(auth boundary + endpoints)*
  - **Workspace outputs (target):** *(no `.aos/**` writes from Product directly)*
  - **Example artifacts:**
    - `nirmata.Web/Clients/ServiceManagerApiClient.cs`
    - `nirmata.Web/Configuration/AgentRunnerMode.cs`
  ...
  - Service Manager API client  
    - **Scope:** `nirmata.Web/Clients/**`  
    - **Outputs:** typed HTTP client for `nirmata.Windows.Service.Api` endpoints  
    - **Verify:** calls Health + submits a no-op command
  - Mode toggle (Direct vs Service)  
    - **Scope:** `nirmata.Web/Configuration/**`  
  ...
  - Minimal auth boundary  
    - **Scope:** `nirmata.Windows.Service.Api/**`  
