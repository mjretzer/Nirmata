...
The system SHALL provide an `IOrchestrator` interface in `nirmata.Agents.Execution.Orchestrator` that serves as the unified entry point for both chat and command workflow execution.
