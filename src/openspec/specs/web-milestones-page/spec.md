...
Defines the current implemented Milestones UI in `nirmata.Web` for viewing and creating milestones via the roadmap artifact and for showing milestone progress derived from state.

- **Lives in:** `nirmata.Web/Pages/Milestones/*`, `.aos/spec/roadmap.json`, `.aos/state/state.json`
