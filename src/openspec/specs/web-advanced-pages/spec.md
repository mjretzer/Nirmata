...
Defines the current implemented advanced operational pages in `nirmata.Web` for engine/agent workflows (Fix planning, Codebase intelligence, Context packs, State/Events, Checkpoints, Validation).

- **Lives in:** `nirmata.Web/Pages/Fix/*`, `nirmata.Web/Pages/Codebase/*`, `nirmata.Web/Pages/Context/*`, `nirmata.Web/Pages/State/*`, `nirmata.Web/Pages/Checkpoints/*`, `nirmata.Web/Pages/Validation/*`
