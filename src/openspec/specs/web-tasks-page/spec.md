...
Defines the current implemented Tasks UI in `nirmata.Web` for browsing task specs and inspecting task artifacts from the selected workspace’s `.aos/spec/tasks/**` directory.

- **Lives in:** `nirmata.Web/Pages/Tasks/*`, `.aos/spec/tasks/<task-id>/*`
