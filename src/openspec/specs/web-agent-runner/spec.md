...
Defines the in-process agent runner integration used by `nirmata.Web` to execute orchestrator commands without requiring an external Windows Service host.

- **Lives in:** `nirmata.Web/AgentRunner/WorkflowClassifier*`, `nirmata.Web/Composition/*`
