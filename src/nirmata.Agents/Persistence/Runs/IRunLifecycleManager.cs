...
namespace nirmata.Agents.Persistence.Runs;
...
public interface IRunLifecycleManager
{
    ...
    /// <summary>
    /// Updates the metadata for an existing run.
    /// </summary>
    /// <param name="runId">The run identifier.</param>
    /// <param name="metadata">The metadata to update.</param>
    /// <param name="ct">Cancellation token.</param>
    Task UpdateRunMetadataAsync(string runId, Dictionary<string, object> metadata, CancellationToken ct = default);
}
