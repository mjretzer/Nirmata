...
**Cause**: The `nirmataAgents:SemanticKernel` section is not present in `appsettings.json`.
...
builder.Configuration["nirmataAgents:SemanticKernel:OpenAi:ApiKey"] = apiKey;
```
...
For issues specific to nirmata:
- Check the [nirmata.Agents README](./README.md) for configuration examples
