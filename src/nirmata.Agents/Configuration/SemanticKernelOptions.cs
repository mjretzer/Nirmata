...
public sealed class SemanticKernelOptions
{
    ...
    /// </summary>
    public const string SectionName = "nirmataAgents:SemanticKernel";
    ...
    [RegularExpression(@"^(OpenAi|AzureOpenAi|Ollama|Anthropic)$", ErrorMessage = "Provider must be one of: OpenAi, AzureOpenAi, Ollama, Anthropic")]
...
{
    /// <summary>
    /// OpenAI API key. Must not be empty or whitespace.
    /// </summary>
    [Required(ErrorMessage = "OpenAI API key is required")]
    [MinLength(1, ErrorMessage = "OpenAI API key cannot be empty")]
    ...
    [MinLength(1, ErrorMessage = "OpenAI model ID cannot be empty")]
...
public sealed class AzureOpenAiSemanticKernelOptions
{
    ...
    /// <summary>
    /// Azure OpenAI API key. Must not be empty or whitespace.
    /// </summary>
    [Required(ErrorMessage = "Azure OpenAI API key is required")]
    [MinLength(1, ErrorMessage = "Azure OpenAI API key cannot be empty")]
    public string ApiKey { get; set; } = string.Empty;
    ...
    [MinLength(1, ErrorMessage = "Azure OpenAI deployment name cannot be empty")]
...
public sealed class OllamaSemanticKernelOptions
{
    ...
    [MinLength(1, ErrorMessage = "Ollama model ID cannot be empty")]
