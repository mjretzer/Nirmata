...
using nirmata.Agents.Execution.ControlPlane.Llm.Anthropic;
...
public static class SemanticKernelServiceCollectionExtensions
{
    ...
    private static void ValidateOpenAiConfiguration(OpenAiSemanticKernelOptions? options, IConfiguration section)
    {
        if (options is null)
        {
            throw new InvalidOperationException(
                ...
                "Ensure 'nirmataAgents:SemanticKernel:OpenAi' section is configured with ApiKey and ModelId. " +
                "Example: {\"nirmataAgents\": {\"SemanticKernel\": {\"OpenAi\": {\"ApiKey\": \"sk-...\", \"ModelId\": \"gpt-4\"}}}}");
        }
        ...
        if (string.IsNullOrWhiteSpace(options.ApiKey))
        {
            throw new InvalidOperationException(
                ...
                "Ensure 'nirmataAgents:SemanticKernel:OpenAi:ApiKey' is set to your OpenAI API key. " +
        ...
        if (string.IsNullOrWhiteSpace(options.ModelId))
        {
            throw new InvalidOperationException(
                ...
                "Ensure 'nirmataAgents:SemanticKernel:OpenAi:ModelId' is set to a valid model (e.g., 'gpt-4', 'gpt-4-turbo', 'gpt-3.5-turbo'). " +
    ...
    private static void ValidateAzureOpenAiConfiguration(AzureOpenAiSemanticKernelOptions? options, IConfiguration section)
    {
        if (options is null)
        {
            throw new InvalidOperationException(
                ...
                "Ensure 'nirmataAgents:SemanticKernel:AzureOpenAi' section is configured with Endpoint, ApiKey, and DeploymentName. " +
                "Example: {\"nirmataAgents\": {\"SemanticKernel\": {\"AzureOpenAi\": {\"Endpoint\": \"https://...\", \"ApiKey\": \"...\", \"DeploymentName\": \"...\"}}}}");
        }
        ...
        if (string.IsNullOrWhiteSpace(options.Endpoint))
        {
            throw new InvalidOperationException(
                ...
                "Ensure 'nirmataAgents:SemanticKernel:AzureOpenAi:Endpoint' is set to your Azure OpenAI endpoint URL.");
        }
        ...
        if (string.IsNullOrWhiteSpace(options.ApiKey))
        {
            throw new InvalidOperationException(
                ...
                "Ensure 'nirmataAgents:SemanticKernel:AzureOpenAi:ApiKey' is set to your Azure OpenAI API key.");
        }
        ...
        if (string.IsNullOrWhiteSpace(options.DeploymentName))
        {
            throw new InvalidOperationException(
                ...
                "Ensure 'nirmataAgents:SemanticKernel:AzureOpenAi:DeploymentName' is set to your deployment name.");
        }
    }
    ...
    private static void ValidateOllamaConfiguration(OllamaSemanticKernelOptions? options, IConfiguration section)
    {
        ...
        if (string.IsNullOrWhiteSpace(options.ModelId))
        {
            throw new InvalidOperationException(
                ...
                "Ensure 'nirmataAgents:SemanticKernel:Ollama:ModelId' is set to a valid Ollama model (e.g., 'llama3', 'mistral', 'codellama'). " +
    ...
    private static void ValidateAnthropicConfiguration(AnthropicSemanticKernelOptions? options, IConfiguration section)
    {
        if (options is null)
        {
            throw new InvalidOperationException(
                ...
                "Ensure 'nirmataAgents:SemanticKernel:Anthropic' section is configured with ApiKey and ModelId. " +
                "Example: {\"nirmataAgents\": {\"SemanticKernel\": {\"Anthropic\": {\"ApiKey\": \"sk-ant-...\", \"ModelId\": \"claude-3-opus-20240229\"}}}}");
        }
        ...
        if (string.IsNullOrWhiteSpace(options.ApiKey))
        {
            throw new InvalidOperationException(
                ...
                "Ensure 'nirmataAgents:SemanticKernel:Anthropic:ApiKey' is set to your Anthropic API key. " +
        ...
        if (string.IsNullOrWhiteSpace(options.ModelId))
        {
            throw new InvalidOperationException(
                ...
                "Ensure 'nirmataAgents:SemanticKernel:Anthropic:ModelId' is set to a valid model (e.g., 'claude-3-opus-20240229', 'claude-3-sonnet-20240229'). " +
        ...
        HttpClient? httpClient = null)
    {
        ...
        if (options is null)
        {
            throw new InvalidOperationException(
                "OpenAI configuration is missing. " +
                "Ensure 'nirmataAgents:SemanticKernel:OpenAi' section is configured.");
        }
        ...
        if (string.IsNullOrWhiteSpace(options.ApiKey))
        {
            throw new InvalidOperationException(
                ...
                "Ensure 'nirmataAgents:SemanticKernel:OpenAi:ApiKey' is set.");
        }
        ...
        if (string.IsNullOrWhiteSpace(options.ModelId))
        {
            throw new InvalidOperationException(
                ...
                "Ensure 'nirmataAgents:SemanticKernel:OpenAi:ModelId' is set.");
        }
        ...
        IConfiguration configuration)
    {
        ...
        if (options is null)
        {
            throw new InvalidOperationException(
                "Azure OpenAI configuration is missing. " +
                "Ensure 'nirmataAgents:SemanticKernel:AzureOpenAi' section is configured.");
        }
        ...
        if (string.IsNullOrWhiteSpace(options.Endpoint))
        {
            throw new InvalidOperationException(
                ...
                "Ensure 'nirmataAgents:SemanticKernel:AzureOpenAi:Endpoint' is set.");
        }
        ...
        if (string.IsNullOrWhiteSpace(options.ApiKey))
        {
            throw new InvalidOperationException(
                ...
                "Ensure 'nirmataAgents:SemanticKernel:AzureOpenAi:ApiKey' is set.");
        }
        ...
        if (string.IsNullOrWhiteSpace(options.DeploymentName))
        {
            throw new InvalidOperationException(
                ...
                "Ensure 'nirmataAgents:SemanticKernel:AzureOpenAi:DeploymentName' is set.");
        }
        ...
        IConfiguration configuration)
    {
        ...
        if (string.IsNullOrWhiteSpace(options.ModelId))
        {
            throw new InvalidOperationException(
                ...
                "Ensure 'nirmataAgents:SemanticKernel:Ollama:ModelId' is set.");
        }
...
#pragma warning restore SKEXP0070
        ...
        IConfiguration configuration)
    {
        ...
        if (options is null)
        {
            throw new InvalidOperationException(
                "Anthropic configuration is missing. " +
                "Ensure 'nirmataAgents:SemanticKernel:Anthropic' section is configured.");
        }
        ...
        if (string.IsNullOrWhiteSpace(options.ApiKey))
        {
            throw new InvalidOperationException(
                ...
                "Ensure 'nirmataAgents:SemanticKernel:Anthropic:ApiKey' is set.");
        }
        ...
        if (string.IsNullOrWhiteSpace(options.ModelId))
        {
            throw new InvalidOperationException(
                ...
                "Ensure 'nirmataAgents:SemanticKernel:Anthropic:ModelId' is set.");
        }
