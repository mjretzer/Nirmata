...
using nirmata.Agents.Models.Contracts;
...
public sealed class RoadmapGenerator : IRoadmapGenerator
{
    ...
    public bool ValidateAgainstSchema(object roadmap, out List<string> errors)
    {
        ...
        try
        {
            ...
            if (schemaValue != "nirmata:aos:schema:roadmap:v1" && schemaValue != "1")
            {
                errors.Add($"Unexpected schema: {schemaValue}. Expected: nirmata:aos:schema:roadmap:v1");
            }
