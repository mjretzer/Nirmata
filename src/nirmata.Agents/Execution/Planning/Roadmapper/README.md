...
The Roadmapper is a critical component of the nirmata orchestration pipeline that bridges the gap between project definition and executable planning phases. It generates deterministic milestone and phase structures based on the validated project specification.
...
All generated artifacts validate against nirmata AOS schemas:
- `nirmata:aos:schema:roadmap:v1`
- `nirmata:aos:schema:milestone:v1`
- `nirmata:aos:schema:phase:v1`
- `nirmata:aos:schema:state:v1`
- `nirmata:aos:schema:event:v1`
