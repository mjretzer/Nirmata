...
public static class ArtifactTransformer
{
    ...
    private static string TransformTaskPlan(string oldJson)
    {
        ...
        obj["schemaVersion"] = 1;
        obj["schemaId"] = "nirmata:aos:schema:task-plan:v1";
    ...
    private static string TransformVerifierInput(string oldJson)
    {
        ...
        // Add schema information
        obj["schemaVersion"] = 1;
        obj["schemaId"] = "nirmata:aos:schema:verifier-input:v1";
    ...
    private static string TransformVerifierOutput(string oldJson)
    {
        ...
        // Add schema information
        obj["schemaVersion"] = 1;
        obj["schemaId"] = "nirmata:aos:schema:verifier-output:v1";
    ...
    private static string TransformFixPlan(string oldJson)
    {
        ...
        // Add schema information
        obj["schemaVersion"] = 1;
        obj["schemaId"] = "nirmata:aos:schema:fix-plan:v1";
    ...
    private static string TransformPhasePlan(string oldJson)
    {
        ...
        // Add schema information
        obj["schemaVersion"] = 1;
        obj["schemaId"] = "nirmata:aos:schema:phase-plan:v1";
