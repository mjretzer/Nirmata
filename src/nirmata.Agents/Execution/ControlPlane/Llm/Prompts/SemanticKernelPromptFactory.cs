...
namespace nirmata.Agents.Execution.ControlPlane.Llm.Prompts;
...
public static class SemanticKernelPromptFactory
{
    ...
    private const string ResourceBasePath = "nirmata.Agents.Resources.Prompts";

    /// <summary>
    /// Creates a KernelFunction from an embedded resource identified by the resource ID.
    /// </summary>
    /// <param name="resourceId">The resource identifier, relative to nirmata.Agents.Resources.Prompts (e.g., "interviews.system" maps to "nirmata.Agents.Resources.Prompts.interviews.system.prompt.txt")</param>
    ...
    /// </summary>
    /// <param name="resourceId">The resource identifier, relative to nirmata.Agents.Resources.Prompts</param>
