...
{
    private const string CommandProposalSchemaResourceName = "nirmata.Aos.Resources.Schemas.command-proposal.schema.json";
    ...
    private static readonly Lazy<LlmStructuredOutputSchema> StructuredCommandProposalSchema = new(() =>
        LlmStructuredOutputSchema.FromJson(
            ...
            description: "nirmata command proposal schema"),
        LazyThreadSafetyMode.ExecutionAndPublication);
